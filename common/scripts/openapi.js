...
fs.writeFileSync('./common/openapi.json', JSON.stringify(openapiSpecification, null, 2), { encoding: 'utf8' });
fs.writeFileSync('./common/openapi.yaml', YAML.stringify(openapiSpecification, null, 2), { encoding: 'utf8' });
...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { ProfilePDF } from './../Controller';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/profile/file/create',

            function ProfilePDF_function(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"form":{"ref":"FormFields","required":true},"template":{"dataType":"string","required":true}}},
            };
            ...
            try {
                ...
                const controller = new ProfilePDF();


              const promise = controller.function.apply(controller, validatedArgs as any);

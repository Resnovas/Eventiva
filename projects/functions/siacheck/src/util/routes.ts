...
const models: TsoaRoute.Models = {
  SIACheck: {
    ...
    properties: {
      ...
      badge: {
        dataType: 'union',
        subSchemas: [{ ref: 'SIABadge' }, { dataType: 'enum', enums: [null] }],
      },
      sia_id: {
        dataType: 'union',
        subSchemas: [
      ...
      status: {
        ...
        subSchemas: [
          ...
          { dataType: 'enum', enums: ['REVOKED'] },
          { dataType: 'enum', enums: ['SUSPENDED'] },
          { dataType: 'enum', enums: ['NON_ACTIVE'] },
        ],
        required: true,
      },
      AuthUrl: {
  ...
  Account: {
    ...
    properties: {
      ...
      employer: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'EmployersOnAccount' },
      },
      employees: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'EmployersOnAccount' },
      ...
      accesses: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'SubuserOnAccount' },
      },
      subusers: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'SubuserOnAccount' },
      ...
      accounts: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ManagersOnAccount' },
      },
      managers: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ManagersOnAccount' },
      ...
      title: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['Miss'] },
          { dataType: 'enum', enums: ['Ms'] },
          { dataType: 'enum', enums: ['Mrs'] },
          { dataType: 'enum', enums: ['Mr'] },
          { dataType: 'enum', enums: ['Dr'] },
          { dataType: 'enum', enums: [null] },
        ],
      },
      firstname: {
      ...
      apiToken: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Token' },
      },
      deleted: {
        dataType: 'union',
        subSchemas: [
      ...
      primaryAddress: {
        dataType: 'union',
        subSchemas: [{ ref: 'Address' }, { dataType: 'enum', enums: [null] }],
      },
      addresses: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Address' },
      },
      contactOfAddress: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ContactAtAddress' },
      },
      application: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Application' },
      },
      emails: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Email' },
      },
      files: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Files' },
      },
      phones: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Phone' },
      },
      rtw: { dataType: 'array', array: { dataType: 'refObject', ref: 'RTW' } },
      sia: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'SIABadge' },
      },
      Status: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'StatusOnAccount' },
      },
      subscription: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'SubscriptionOnAccount' },
      },
      transactions: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Transaction' },
      },
      _count: {
        dataType: 'union',
        subSchemas: [
  ...
  Address: {
    ...
    properties: {
      ...
      venueStyle: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'VenueStyle' },
      },
      ...
      primaryAccount: {
        dataType: 'union',
        subSchemas: [{ ref: 'Account' }, { dataType: 'enum', enums: [null] }],
      },
      primaryaccountId: {
        dataType: 'union',
        subSchemas: [
      ...
      featuresOfBuisness: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'FeatureOfAddress' },
      },
      phones: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Phone' },
      ...
      rooms: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Room' },
      },
      _count: {
        dataType: 'union',
        subSchemas: [
  ...
  ContactAtAddress: {
    ...
    properties: {
      ...
      email: {
        dataType: 'union',
        subSchemas: [{ ref: 'Email' }, { dataType: 'enum', enums: [null] }],
      },
      emailId: {
        dataType: 'union',
        subSchemas: [
  ...
  Email: {
    ...
    properties: {
      ...
      domain: {
        dataType: 'union',
        subSchemas: [{ ref: 'Domain' }, { dataType: 'enum', enums: [null] }],
      },
      domainId: {
        dataType: 'union',
        subSchemas: [
  ...
  Domain: {
    ...
    properties: {
      ...
      dnsType: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['TXT'] },
          { dataType: 'enum', enums: ['CNAME'] },
        ],
        required: true,
      },
      linkedEmails: {
  ...
  Feature: {
    ...
    properties: {
      ...
      featureOfRoom: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'FeatureOfRoom' },
      },
      featureOfAddress: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'FeatureOfAddress' },
  ...
  Arrangement: {
    ...
    properties: {
      ...
      room: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ArrangementOfRoom' },
      },
      name: { dataType: 'string', required: true },
      icon: {
        dataType: 'union',
  ...
  Room: {
    ...
    properties: {
      ...
      _count: {
        dataType: 'union',
        subSchemas: [{ ref: 'RoomCount' }, { dataType: 'enum', enums: [null] }],
      },
    },
    additionalProperties: false,
  },
  ...
  Files: {
    ...
    properties: {
      ...
      rtw: {
        dataType: 'union',
        subSchemas: [{ ref: 'RTW' }, { dataType: 'enum', enums: [null] }],
      },
      rtwId: {
        dataType: 'union',
        subSchemas: [
      ...
      account: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'Account' },
      },
      createdAt: { dataType: 'datetime', required: true },
      updatedAt: { dataType: 'datetime', required: true },
      deleted: {
  ...
  RTW: {
    ...
    properties: {
      ...
      _count: {
        dataType: 'union',
        subSchemas: [{ ref: 'RTWCount' }, { dataType: 'enum', enums: [null] }],
      },
    },
    additionalProperties: false,
  },
  ...
  SIABadge: {
    ...
    properties: {
      ...
      licenseSector: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['CVIT'] },
          { dataType: 'enum', enums: ['CP'] },
          { dataType: 'enum', enums: ['DS'] },
          { dataType: 'enum', enums: ['CCTV'] },
          { dataType: 'enum', enums: ['SG'] },
          { dataType: 'enum', enums: ['VI'] },
          { dataType: 'enum', enums: ['KH'] },
      ...
      type: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['FRONTLINE'] },
          { dataType: 'enum', enums: ['NON_FRONTLINE'] },
        ],
        required: true,
      },
      ...
      siaChecks: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'SIACheck' },
      },
      account: {
        dataType: 'union',
        subSchemas: [{ ref: 'Account' }, { dataType: 'enum', enums: [null] }],
  ...
  License: {
    ...
    type: {
      dataType: 'double',
      validators: { pattern: { value: '10[0-9]{14}' } },
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: express.Router) {
  ...
  app.get(
    ...
    function SIACheckController_checkLicense(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.checkLicense.apply(
          controller,

...
import { AccountCreateNestedOneWithoutEmailsInput } from "../inputs/AccountCreateNestedOneWithoutEmailsInput";
import { ContactAtAddressCreateNestedManyWithoutEmailInput } from "../inputs/ContactAtAddressCreateNestedManyWithoutEmailInput";
import { DomainCreateNestedOneWithoutLinkedEmailsInput } from "../inputs/DomainCreateNestedOneWithoutLinkedEmailsInput";

@TypeGraphQL.InputType("EmailCreateInput", {
  isAbstract: true
})
export class EmailCreateInput {
  ...
  @TypeGraphQL.Field(_type => ContactAtAddressCreateNestedManyWithoutEmailInput, {
    nullable: true
  })
  associatedContact?: ContactAtAddressCreateNestedManyWithoutEmailInput | undefined;

  @TypeGraphQL.Field(_type => DomainCreateNestedOneWithoutLinkedEmailsInput, {
    nullable: true
  })
  ...
  @TypeGraphQL.Field(_type => AccountCreateNestedOneWithoutEmailsInput, {
    nullable: true
  })
  account?: AccountCreateNestedOneWithoutEmailsInput | undefined;

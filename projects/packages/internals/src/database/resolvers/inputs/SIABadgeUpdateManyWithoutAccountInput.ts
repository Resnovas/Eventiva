...
export class SIABadgeUpdateManyWithoutAccountInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [SIABadgeUpsertWithWhereUniqueWithoutAccountInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [SIABadgeUpdateWithWhereUniqueWithoutAccountInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [SIABadgeUpdateManyWithWhereWithoutAccountInput],
    {
      nullable: true,
    }
  )

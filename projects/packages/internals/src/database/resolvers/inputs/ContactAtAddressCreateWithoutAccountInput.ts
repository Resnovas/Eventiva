...
@TypeGraphQL.InputType('ContactAtAddressCreateWithoutAccountInput', {
  isAbstract: true,
})
export class ContactAtAddressCreateWithoutAccountInput {
  ...
  @TypeGraphQL.Field(
    (_type) => EmailCreateNestedOneWithoutAssociatedContactInput,
    {
      nullable: true,
    }
  )

...
export class ContactAtAddressUpdateManyWithoutEmailInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [ContactAtAddressCreateOrConnectWithoutEmailInput],
    {
      nullable: true,
    }
  )
  connectOrCreate?:
    | ContactAtAddressCreateOrConnectWithoutEmailInput[]
    | undefined;

  @TypeGraphQL.Field(
    (_type) => [ContactAtAddressUpsertWithWhereUniqueWithoutEmailInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [ContactAtAddressUpdateWithWhereUniqueWithoutEmailInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [ContactAtAddressUpdateManyWithWhereWithoutEmailInput],
    {
      nullable: true,
    }
  )
  updateMany?:
    | ContactAtAddressUpdateManyWithWhereWithoutEmailInput[]
    | undefined;

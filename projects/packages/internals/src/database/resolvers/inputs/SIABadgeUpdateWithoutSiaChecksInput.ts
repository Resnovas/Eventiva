...
import { AccountUpdateOneWithoutSiaInput } from '../inputs/AccountUpdateOneWithoutSiaInput';
...
@TypeGraphQL.InputType('SIABadgeUpdateWithoutSiaChecksInput', {
  isAbstract: true,
})
export class SIABadgeUpdateWithoutSiaChecksInput {
  ...
  @TypeGraphQL.Field((_type) => AccountUpdateOneWithoutSiaInput, {
    nullable: true,
  })
  account?: AccountUpdateOneWithoutSiaInput | undefined;
}

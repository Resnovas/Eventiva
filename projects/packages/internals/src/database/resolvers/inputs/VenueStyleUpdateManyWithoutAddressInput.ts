...
export class VenueStyleUpdateManyWithoutAddressInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [VenueStyleUpsertWithWhereUniqueWithoutAddressInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [VenueStyleUpdateWithWhereUniqueWithoutAddressInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [VenueStyleUpdateManyWithWhereWithoutAddressInput],
    {
      nullable: true,
    }
  )

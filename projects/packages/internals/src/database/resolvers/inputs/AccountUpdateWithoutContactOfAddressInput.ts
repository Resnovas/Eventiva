...
import { ManagersOnAccountUpdateManyWithoutAccountInput } from '../inputs/ManagersOnAccountUpdateManyWithoutAccountInput';
...
@TypeGraphQL.InputType('AccountUpdateWithoutContactOfAddressInput', {
  isAbstract: true,
})
export class AccountUpdateWithoutContactOfAddressInput {
  ...
  @TypeGraphQL.Field(
    (_type) => EmployersOnAccountUpdateManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => EmployersOnAccountUpdateManyWithoutEmployerInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => ManagersOnAccountUpdateManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => ManagersOnAccountUpdateManyWithoutManagersInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => SubscriptionOnAccountUpdateManyWithoutAccountInput,
    {
      nullable: true,
    }
  )

...
export class FeatureOfAddressCreateInput {
  @TypeGraphQL.Field(_type => FeatureCreateNestedOneWithoutFeatureOfAddressInput, {
    nullable: false
  })
  feature!: FeatureCreateNestedOneWithoutFeatureOfAddressInput;

  @TypeGraphQL.Field(_type => AddressCreateNestedOneWithoutFeaturesOfBuisnessInput, {
    nullable: false
  })

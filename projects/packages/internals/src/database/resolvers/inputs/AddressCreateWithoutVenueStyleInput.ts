...
import { AccountCreateNestedOneWithoutAddressesInput } from "../inputs/AccountCreateNestedOneWithoutAddressesInput";
...
@TypeGraphQL.InputType("AddressCreateWithoutVenueStyleInput", {
  isAbstract: true
})
export class AddressCreateWithoutVenueStyleInput {
  ...
  @TypeGraphQL.Field(_type => AccountCreateNestedOneWithoutAddressesInput, {
    nullable: false
  })
  ...
  @TypeGraphQL.Field(_type => ContactAtAddressCreateNestedManyWithoutAddressInput, {
    nullable: true
  })
  ...
  @TypeGraphQL.Field(_type => AccountCreateNestedOneWithoutPrimaryAddressInput, {
    nullable: true
  })
  ...
  @TypeGraphQL.Field(_type => FeatureOfAddressCreateNestedManyWithoutAddressInput, {
    nullable: true
  })
  featuresOfBuisness?: FeatureOfAddressCreateNestedManyWithoutAddressInput | undefined;

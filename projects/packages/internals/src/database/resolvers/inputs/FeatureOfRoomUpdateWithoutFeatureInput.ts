...
@TypeGraphQL.InputType('FeatureOfRoomUpdateWithoutFeatureInput', {
  isAbstract: true,
})
export class FeatureOfRoomUpdateWithoutFeatureInput {
  ...
  @TypeGraphQL.Field(
    (_type) => RoomUpdateOneRequiredWithoutFeaturesOfRoomInput,
    {
      nullable: true,
    }
  )

...
import { NestedEnumFeatureTypeWithAggregatesFilter } from "../inputs/NestedEnumFeatureTypeWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { FeatureType } from "../../enums/FeatureType";

@TypeGraphQL.InputType("EnumFeatureTypeWithAggregatesFilter", {
  isAbstract: true
})
export class EnumFeatureTypeWithAggregatesFilter {

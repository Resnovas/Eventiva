...
import { TokenCreateNestedManyWithoutAccountInput } from '../inputs/TokenCreateNestedManyWithoutAccountInput';
...
@TypeGraphQL.InputType('AccountCreateWithoutAddressesInput', {
  isAbstract: true,
})
export class AccountCreateWithoutAddressesInput {
  ...
  @TypeGraphQL.Field(
    (_type) => EmployersOnAccountCreateNestedManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => EmployersOnAccountCreateNestedManyWithoutEmployerInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => SubuserOnAccountCreateNestedManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => SubuserOnAccountCreateNestedManyWithoutSubuserInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => ManagersOnAccountCreateNestedManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => ManagersOnAccountCreateNestedManyWithoutManagersInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field((_type) => TokenCreateNestedManyWithoutAccountInput, {
    nullable: true,
  })
  apiToken?: TokenCreateNestedManyWithoutAccountInput | undefined;

  @TypeGraphQL.Field(
    (_type) => AddressCreateNestedOneWithoutPrimaryAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => ContactAtAddressCreateNestedManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => ApplicationCreateNestedManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => StatusOnAccountCreateNestedManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => SubscriptionOnAccountCreateNestedManyWithoutAccountInput,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => TransactionCreateNestedManyWithoutAccountInput,
    {
      nullable: true,
    }
  )

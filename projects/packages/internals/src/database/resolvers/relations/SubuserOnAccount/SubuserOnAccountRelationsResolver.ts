...
export class SubuserOnAccountRelationsResolver {
  ...
  async account(@TypeGraphQL.Root() subuserOnAccount: SubuserOnAccount, @TypeGraphQL.Ctx() ctx: any): Promise<Account> {
  ...
  async subuser(@TypeGraphQL.Root() subuserOnAccount: SubuserOnAccount, @TypeGraphQL.Ctx() ctx: any): Promise<Account> {
    return getPrismaFromContext(ctx).subuserOnAccount.findUnique({
      where: {
        accountId_subuserId: {
          accountId: subuserOnAccount.accountId,

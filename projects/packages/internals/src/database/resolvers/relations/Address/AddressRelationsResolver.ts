...
export class AddressRelationsResolver {
  ...
  async contacts(
    @TypeGraphQL.Root() address: Address,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AddressContactsArgs
  ...
  async venueStyle(
    @TypeGraphQL.Root() address: Address,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AddressVenueStyleArgs
  ): Promise<VenueStyle[]> {
    return getPrismaFromContext(ctx)
      .address.findUnique({
        where: {
  ...
  async featuresOfBuisness(
    @TypeGraphQL.Root() address: Address,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AddressFeaturesOfBuisnessArgs
  ...
  async phones(
    @TypeGraphQL.Root() address: Address,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AddressPhonesArgs
  ): Promise<Phone[]> {
    return getPrismaFromContext(ctx)
      .address.findUnique({
        where: {
  ...
  async rooms(
    @TypeGraphQL.Root() address: Address,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AddressRoomsArgs
  ): Promise<Room[]> {
    return getPrismaFromContext(ctx)
      .address.findUnique({
        where: {

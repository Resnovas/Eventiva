...
export class SIABadgeCrudResolver {
  ...
  async sIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindUniqueSIABadgeArgs): Promise<SIABadge | null> {
  ...
  async findFirstSIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindFirstSIABadgeArgs): Promise<SIABadge | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async createSIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateSIABadgeArgs): Promise<SIABadge> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteSIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteSIABadgeArgs): Promise<SIABadge | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteManySIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteManySIABadgeArgs): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async updateManySIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpdateManySIABadgeArgs): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertSIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertSIABadgeArgs): Promise<SIABadge> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async aggregateSIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: AggregateSIABadgeArgs): Promise<AggregateSIABadge> {
  ...
  async groupBySIABadge(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: GroupBySIABadgeArgs): Promise<SIABadgeGroupBy[]> {

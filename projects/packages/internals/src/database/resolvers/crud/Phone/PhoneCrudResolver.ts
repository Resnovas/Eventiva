...
export class PhoneCrudResolver {
  ...
  async phone(
    ...
    @TypeGraphQL.Args() args: FindUniquePhoneArgs
  ): Promise<Phone | null> {
  ...
  async createPhone(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreatePhoneArgs
  ): Promise<Phone> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyPhone(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyPhoneArgs
  ...
  async deletePhone(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeletePhoneArgs
  ): Promise<Phone | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateManyPhone(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyPhoneArgs
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async upsertPhone(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertPhoneArgs
  ): Promise<Phone> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregatePhone(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregatePhoneArgs
  ): Promise<AggregatePhone> {

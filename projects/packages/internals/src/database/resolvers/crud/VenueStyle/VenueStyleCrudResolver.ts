...
export class VenueStyleCrudResolver {
  ...
  async venueStyle(
    ...
    @TypeGraphQL.Args() args: FindUniqueVenueStyleArgs
  ...
  async venueStyles(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyVenueStyleArgs
  ): Promise<VenueStyle[]> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createVenueStyle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateVenueStyleArgs
  ): Promise<VenueStyle> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyVenueStyle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyVenueStyleArgs
  ...
  async deleteVenueStyle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteVenueStyleArgs
  ): Promise<VenueStyle | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateVenueStyle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateVenueStyleArgs
  ): Promise<VenueStyle | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async deleteManyVenueStyle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyVenueStyleArgs
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregateVenueStyle(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateVenueStyleArgs
  ): Promise<AggregateVenueStyle> {

...
export class RTWCrudResolver {
  ...
  async rTW(
    ...
    @TypeGraphQL.Args() args: FindUniqueRTWArgs
  ): Promise<RTW | null> {
  ...
  async findFirstRTW(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstRTWArgs
  ): Promise<RTW | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async rTWS(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyRTWArgs
  ): Promise<RTW[]> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createRTW(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateRTWArgs
  ): Promise<RTW> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyRTW(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyRTWArgs
  ...
  async updateRTW(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateRTWArgs
  ): Promise<RTW | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async deleteManyRTW(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyRTWArgs
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateManyRTW(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyRTWArgs
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async groupByRTW(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByRTWArgs
  ): Promise<RTWGroupBy[]> {

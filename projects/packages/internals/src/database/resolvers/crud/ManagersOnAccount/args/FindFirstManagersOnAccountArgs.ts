...
export class FindFirstManagersOnAccountArgs {
  ...
  @TypeGraphQL.Field(
    (_type) => [ManagersOnAccountOrderByWithRelationAndSearchRelevanceInput],
    {
      nullable: true,
    }
  )
  ...
  distinct?:
    | Array<'accountId' | 'managersId' | 'createdAt' | 'updatedAt'>
    | undefined;
}

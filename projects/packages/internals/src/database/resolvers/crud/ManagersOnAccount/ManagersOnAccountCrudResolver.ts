...
export class ManagersOnAccountCrudResolver {
  ...
  async managersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindUniqueManagersOnAccountArgs): Promise<ManagersOnAccount | null> {
  ...
  async findFirstManagersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindFirstManagersOnAccountArgs): Promise<ManagersOnAccount | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async createManagersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateManagersOnAccountArgs): Promise<ManagersOnAccount> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async updateManagersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpdateManagersOnAccountArgs): Promise<ManagersOnAccount | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async groupByManagersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: GroupByManagersOnAccountArgs): Promise<ManagersOnAccountGroupBy[]> {

...
export class SubuserOnAccountCrudResolver {
  ...
  async findFirstSubuserOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindFirstSubuserOnAccountArgs): Promise<SubuserOnAccount | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async updateSubuserOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpdateSubuserOnAccountArgs): Promise<SubuserOnAccount | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertSubuserOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertSubuserOnAccountArgs): Promise<SubuserOnAccount> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async aggregateSubuserOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: AggregateSubuserOnAccountArgs): Promise<AggregateSubuserOnAccount> {

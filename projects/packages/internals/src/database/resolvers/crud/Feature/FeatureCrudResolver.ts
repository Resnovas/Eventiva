...
export class FeatureCrudResolver {
  ...
  async feature(
    ...
    @TypeGraphQL.Args() args: FindUniqueFeatureArgs
  ...
  async findFirstFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstFeatureArgs
  ): Promise<Feature | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async features(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyFeatureArgs
  ): Promise<Feature[]> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateFeatureArgs
  ): Promise<Feature> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyFeatureArgs
  ...
  async deleteFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteFeatureArgs
  ): Promise<Feature | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateFeatureArgs
  ): Promise<Feature | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async deleteManyFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyFeatureArgs
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateManyFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyFeatureArgs
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async upsertFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertFeatureArgs
  ): Promise<Feature> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregateFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateFeatureArgs
  ): Promise<AggregateFeature> {
  ...
  async groupByFeature(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByFeatureArgs
  ): Promise<FeatureGroupBy[]> {

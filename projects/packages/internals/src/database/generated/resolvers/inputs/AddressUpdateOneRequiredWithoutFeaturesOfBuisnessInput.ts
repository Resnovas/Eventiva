...
@TypeGraphQL.InputType("AddressUpdateOneRequiredWithoutFeaturesOfBuisnessInput", {
  isAbstract: true
})
export class AddressUpdateOneRequiredWithoutFeaturesOfBuisnessInput {
  ...
  @TypeGraphQL.Field(_type => AddressCreateOrConnectWithoutFeaturesOfBuisnessInput, {
    nullable: true
  })
  connectOrCreate?: AddressCreateOrConnectWithoutFeaturesOfBuisnessInput | undefined;

...
import { NestedEnumAddressTypeWithAggregatesFilter } from "../inputs/NestedEnumAddressTypeWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { AddressType } from "../../enums/AddressType";

@TypeGraphQL.InputType("EnumAddressTypeWithAggregatesFilter", {
  isAbstract: true
})
export class EnumAddressTypeWithAggregatesFilter {

...
export class FeatureOfRoomCrudResolver {
  ...
  async featureOfRooms(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindManyFeatureOfRoomArgs): Promise<FeatureOfRoom[]> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteFeatureOfRoom(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteFeatureOfRoomArgs): Promise<FeatureOfRoom | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertFeatureOfRoom(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertFeatureOfRoomArgs): Promise<FeatureOfRoom> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );

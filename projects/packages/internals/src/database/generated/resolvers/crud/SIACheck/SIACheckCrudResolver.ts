...
export class SIACheckCrudResolver {
  ...
  async sIACheck(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindUniqueSIACheckArgs): Promise<SIACheck | null> {
  ...
  async findFirstSIACheck(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindFirstSIACheckArgs): Promise<SIACheck | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async sIAChecks(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindManySIACheckArgs): Promise<SIACheck[]> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async createSIACheck(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateSIACheckArgs): Promise<SIACheck> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteManySIACheck(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteManySIACheckArgs): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async updateManySIACheck(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpdateManySIACheckArgs): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async aggregateSIACheck(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: AggregateSIACheckArgs): Promise<AggregateSIACheck> {
  ...
  async groupBySIACheck(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: GroupBySIACheckArgs): Promise<SIACheckGroupBy[]> {

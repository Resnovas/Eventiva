...
export class EmployersOnAccountCrudResolver {
  ...
  async employersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindUniqueEmployersOnAccountArgs): Promise<EmployersOnAccount | null> {
  ...
  async createEmployersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateEmployersOnAccountArgs): Promise<EmployersOnAccount> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async deleteEmployersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: DeleteEmployersOnAccountArgs): Promise<EmployersOnAccount | null> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async upsertEmployersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: UpsertEmployersOnAccountArgs): Promise<EmployersOnAccount> {
    const { _count } = transformFields(
      graphqlFields(info as any)
    );
  ...
  async aggregateEmployersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: AggregateEmployersOnAccountArgs): Promise<AggregateEmployersOnAccount> {
  ...
  async groupByEmployersOnAccount(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: GroupByEmployersOnAccountArgs): Promise<EmployersOnAccountGroupBy[]> {

...
export class SubscriptionOnAccountRelationsResolver {
  ...
  async subscription(@TypeGraphQL.Root() subscriptionOnAccount: SubscriptionOnAccount, @TypeGraphQL.Ctx() ctx: any): Promise<Subscription> {
  ...
  async account(@TypeGraphQL.Root() subscriptionOnAccount: SubscriptionOnAccount, @TypeGraphQL.Ctx() ctx: any): Promise<Account> {
    return getPrismaFromContext(ctx).subscriptionOnAccount.findUnique({
      where: {
        accountId_subscriptionId: {
          accountId: subscriptionOnAccount.accountId,

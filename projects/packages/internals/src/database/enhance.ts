...
const relationResolversInfo = {
  Account: ["employer", "employees", "accesses", "subusers", "accounts", "managers", "apiToken", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  Token: ["account"],
...
const modelsInfo = {
  Account: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  Token: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  ...
  Address: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted"],
  ContactAtAddress: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  ...
  Domain: ["id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted"],
  Feature: ["id", "name", "type", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoom: ["roomId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddress: ["addressId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  Room: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  Files: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  RTW: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  Phone: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  ArrangementOfRoom: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  Arrangement: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  SIABadge: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  SIACheck: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  StatusOnAccount: ["statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  Status: ["id", "name", "createdAt", "updatedAt", "deleted"],
  Subscription: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  SubscriptionOnAccount: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
...
const outputsInfo = {
  ...
  AccountGroupBy: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted", "_count", "_min", "_max"],
  AggregateToken: ["_count", "_min", "_max"],
  TokenGroupBy: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken", "_count", "_min", "_max"],
  AggregateSubuserOnAccount: ["_count", "_min", "_max"],
  SubuserOnAccountGroupBy: ["accountId", "subuserId", "createdAt", "updatedAt", "_count", "_min", "_max"],
  AggregateEmployersOnAccount: ["_count", "_min", "_max"],
  EmployersOnAccountGroupBy: ["accountId", "employerId", "createdAt", "updatedAt", "_count", "_min", "_max"],
  AggregateManagersOnAccount: ["_count", "_min", "_max"],
  ManagersOnAccountGroupBy: ["accountId", "managersId", "createdAt", "updatedAt", "_count", "_min", "_max"],
  AggregateAddress: ["_count", "_min", "_max"],
  AddressGroupBy: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted", "_count", "_min", "_max"],
  AggregateContactAtAddress: ["_count", "_min", "_max"],
  ContactAtAddressGroupBy: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateVenueStyle: ["_count", "_min", "_max"],
  VenueStyleGroupBy: ["id", "createdAt", "updatedAt", "name", "details", "_count", "_min", "_max"],
  AggregateEmail: ["_count", "_avg", "_sum", "_min", "_max"],
  EmailGroupBy: ["id", "domainId", "email", "accountId", "verified", "public", "primary", "path", "copy", "notifyFrom", "imap_authUser", "imap_authPass", "imap_accessToken", "imap_authServer", "imap_host", "imap_port", "imap_secure", "imap_tslRejectUnauthorized", "imap_tslMinVersion", "imap_resyncDelay", "smtp_authUser", "smtp_authPass", "smtp_accessToken", "smtp_authServer", "smtp_host", "smtp_port", "smtp_secure", "smtp_tslRejectUnauthorized", "smtp_tslMinVersion", "oauth2_authorize", "oauth2_provider", "oauth2_authUser", "oauth2_accessToken", "oauth2_refreshToken", "oauth2_expires", "createdAt", "updatedAt", "deleted", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateApplication: ["_count", "_min", "_max"],
  ApplicationGroupBy: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateDomain: ["_count", "_min", "_max"],
  DomainGroupBy: ["id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateFeature: ["_count", "_min", "_max"],
  FeatureGroupBy: ["id", "name", "type", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateFeatureOfRoom: ["_count", "_min", "_max"],
  FeatureOfRoomGroupBy: ["roomId", "featureId", "data", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateFeatureOfAddress: ["_count", "_min", "_max"],
  FeatureOfAddressGroupBy: ["addressId", "featureId", "data", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateRoom: ["_count", "_min", "_max"],
  RoomGroupBy: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "_count", "_min", "_max"],
  AggregateFiles: ["_count", "_min", "_max"],
  FilesGroupBy: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateRTW: ["_count", "_min", "_max"],
  RTWGroupBy: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregatePhone: ["_count", "_min", "_max"],
  PhoneGroupBy: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public", "_count", "_min", "_max"],
  AggregateArrangementOfRoom: ["_count", "_avg", "_sum", "_min", "_max"],
  ArrangementOfRoomGroupBy: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateArrangement: ["_count", "_min", "_max"],
  ArrangementGroupBy: ["id", "createdAt", "updatedAt", "name", "icon", "details", "_count", "_min", "_max"],
  AggregateSIABadge: ["_count", "_avg", "_sum", "_min", "_max"],
  SIABadgeGroupBy: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateSIACheck: ["_count", "_avg", "_sum", "_min", "_max"],
  SIACheckGroupBy: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateStatusOnAccount: ["_count", "_min", "_max"],
  StatusOnAccountGroupBy: ["statusId", "accountId", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateStatus: ["_count", "_min", "_max"],
  StatusGroupBy: ["id", "name", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateSubscription: ["_count", "_min", "_max"],
  SubscriptionGroupBy: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details", "_count", "_min", "_max"],
  AggregateSubscriptionOnAccount: ["_count", "_min", "_max"],
  SubscriptionOnAccountGroupBy: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted", "_count", "_min", "_max"],
  AggregateTransaction: ["_count", "_min", "_max"],
  TransactionGroupBy: ["id", "createdAt", "updatedAt", "deleted", "accountId", "data", "_count", "_min", "_max"],
  ...
  AccountCountAggregate: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted", "_all"],
  AccountMinAggregate: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  AccountMaxAggregate: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  TokenCountAggregate: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken", "_all"],
  TokenMinAggregate: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  TokenMaxAggregate: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  SubuserOnAccountCountAggregate: ["accountId", "subuserId", "createdAt", "updatedAt", "_all"],
  SubuserOnAccountMinAggregate: ["accountId", "subuserId", "createdAt", "updatedAt"],
  SubuserOnAccountMaxAggregate: ["accountId", "subuserId", "createdAt", "updatedAt"],
  EmployersOnAccountCountAggregate: ["accountId", "employerId", "createdAt", "updatedAt", "_all"],
  EmployersOnAccountMinAggregate: ["accountId", "employerId", "createdAt", "updatedAt"],
  EmployersOnAccountMaxAggregate: ["accountId", "employerId", "createdAt", "updatedAt"],
  ManagersOnAccountCountAggregate: ["accountId", "managersId", "createdAt", "updatedAt", "_all"],
  ManagersOnAccountMinAggregate: ["accountId", "managersId", "createdAt", "updatedAt"],
  ManagersOnAccountMaxAggregate: ["accountId", "managersId", "createdAt", "updatedAt"],
  AddressCount: ["contacts", "venueStyle", "featuresOfBuisness", "phones", "rooms"],
  AddressCountAggregate: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted", "_all"],
  AddressMinAggregate: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "features", "public", "primaryaccountId", "deleted"],
  AddressMaxAggregate: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "features", "public", "primaryaccountId", "deleted"],
  ContactAtAddressCountAggregate: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted", "_all"],
  ContactAtAddressMinAggregate: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  ContactAtAddressMaxAggregate: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  VenueStyleCount: ["address"],
  VenueStyleCountAggregate: ["id", "createdAt", "updatedAt", "name", "details", "_all"],
  ...
  EmailCountAggregate: ["id", "domainId", "email", "accountId", "verified", "public", "primary", "path", "copy", "notifyFrom", "imap_authUser", "imap_authPass", "imap_accessToken", "imap_authServer", "imap_host", "imap_port", "imap_secure", "imap_tslRejectUnauthorized", "imap_tslMinVersion", "imap_resyncDelay", "smtp_authUser", "smtp_authPass", "smtp_accessToken", "smtp_authServer", "smtp_host", "smtp_port", "smtp_secure", "smtp_tslRejectUnauthorized", "smtp_tslMinVersion", "oauth2_authorize", "oauth2_provider", "oauth2_authUser", "oauth2_accessToken", "oauth2_refreshToken", "oauth2_expires", "createdAt", "updatedAt", "deleted", "_all"],
  ...
  ApplicationCountAggregate: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted", "_all"],
  ApplicationMinAggregate: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted"],
  ApplicationMaxAggregate: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted"],
  DomainCount: ["linkedEmails"],
  DomainCountAggregate: ["id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted", "_all"],
  DomainMinAggregate: ["id", "domain", "verified", "dnsType", "createdAt", "updatedAt", "deleted"],
  DomainMaxAggregate: ["id", "domain", "verified", "dnsType", "createdAt", "updatedAt", "deleted"],
  FeatureCount: ["featureOfRoom", "featureOfAddress"],
  FeatureCountAggregate: ["id", "name", "type", "createdAt", "updatedAt", "deleted", "_all"],
  FeatureMinAggregate: ["id", "name", "type", "createdAt", "updatedAt", "deleted"],
  FeatureMaxAggregate: ["id", "name", "type", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomCountAggregate: ["roomId", "featureId", "data", "createdAt", "updatedAt", "deleted", "_all"],
  FeatureOfRoomMinAggregate: ["roomId", "featureId", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomMaxAggregate: ["roomId", "featureId", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressCountAggregate: ["addressId", "featureId", "data", "createdAt", "updatedAt", "deleted", "_all"],
  FeatureOfAddressMinAggregate: ["addressId", "featureId", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressMaxAggregate: ["addressId", "featureId", "createdAt", "updatedAt", "deleted"],
  RoomCount: ["featuresOfRoom", "arrangements"],
  RoomCountAggregate: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "_all"],
  RoomMinAggregate: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  RoomMaxAggregate: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  FilesCount: ["account"],
  FilesCountAggregate: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted", "_all"],
  FilesMinAggregate: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  FilesMaxAggregate: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  RTWCount: ["files"],
  RTWCountAggregate: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted", "_all"],
  RTWMinAggregate: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  RTWMaxAggregate: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  PhoneCountAggregate: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public", "_all"],
  PhoneMinAggregate: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  PhoneMaxAggregate: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  ArrangementOfRoomCountAggregate: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt", "_all"],
  ArrangementOfRoomAvgAggregate: ["capacity"],
  ArrangementOfRoomSumAggregate: ["capacity"],
  ArrangementOfRoomMinAggregate: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomMaxAggregate: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementCount: ["room"],
  ArrangementCountAggregate: ["id", "createdAt", "updatedAt", "name", "icon", "details", "_all"],
  ArrangementMinAggregate: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  ArrangementMaxAggregate: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  SIABadgeCount: ["siaChecks"],
  SIABadgeCountAggregate: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id", "_all"],
  SIABadgeAvgAggregate: ["id"],
  SIABadgeSumAggregate: ["id"],
  SIABadgeMinAggregate: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  SIABadgeMaxAggregate: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  SIACheckCountAggregate: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId", "_all"],
  SIACheckAvgAggregate: ["sia_id"],
  SIACheckSumAggregate: ["sia_id"],
  SIACheckMinAggregate: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  SIACheckMaxAggregate: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  StatusOnAccountCountAggregate: ["statusId", "accountId", "createdAt", "updatedAt", "deleted", "_all"],
  StatusOnAccountMinAggregate: ["statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  StatusOnAccountMaxAggregate: ["statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  StatusCount: ["account"],
  StatusCountAggregate: ["id", "name", "createdAt", "updatedAt", "deleted", "_all"],
  ...
  SubscriptionCountAggregate: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details", "_all"],
  SubscriptionMinAggregate: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  SubscriptionMaxAggregate: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  SubscriptionOnAccountCountAggregate: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted", "_all"],
  SubscriptionOnAccountMinAggregate: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountMaxAggregate: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  TransactionCount: ["SIACheck"],
  TransactionCountAggregate: ["id", "createdAt", "updatedAt", "deleted", "accountId", "data", "_all"],
  TransactionMinAggregate: ["id", "createdAt", "updatedAt", "deleted", "accountId"],
  TransactionMaxAggregate: ["id", "createdAt", "updatedAt", "deleted", "accountId"]
};
...
const inputsInfo = {
  AccountWhereInput: ["AND", "OR", "NOT", "id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountOrderByWithRelationAndSearchRelevanceInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions", "_relevance"],
  AccountWhereUniqueInput: ["id", "username", "resetPasswordToken"],
  AccountOrderByWithAggregationInput: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted", "_count", "_max", "_min"],
  AccountScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  TokenWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "account", "apiToken"],
  TokenOrderByWithRelationAndSearchRelevanceInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "account", "apiToken", "_relevance"],
  TokenWhereUniqueInput: ["id", "value"],
  TokenOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken", "_count", "_max", "_min"],
  TokenScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  SubuserOnAccountWhereInput: ["AND", "OR", "NOT", "accountId", "subuserId", "account", "subuser", "createdAt", "updatedAt"],
  SubuserOnAccountOrderByWithRelationAndSearchRelevanceInput: ["accountId", "subuserId", "account", "subuser", "createdAt", "updatedAt", "_relevance"],
  SubuserOnAccountWhereUniqueInput: ["accountId_subuserId"],
  SubuserOnAccountOrderByWithAggregationInput: ["accountId", "subuserId", "createdAt", "updatedAt", "_count", "_max", "_min"],
  SubuserOnAccountScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "accountId", "subuserId", "createdAt", "updatedAt"],
  EmployersOnAccountWhereInput: ["AND", "OR", "NOT", "accountId", "employerId", "account", "employer", "createdAt", "updatedAt"],
  EmployersOnAccountOrderByWithRelationAndSearchRelevanceInput: ["accountId", "employerId", "account", "employer", "createdAt", "updatedAt", "_relevance"],
  EmployersOnAccountWhereUniqueInput: ["accountId_employerId"],
  EmployersOnAccountOrderByWithAggregationInput: ["accountId", "employerId", "createdAt", "updatedAt", "_count", "_max", "_min"],
  EmployersOnAccountScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "accountId", "employerId", "createdAt", "updatedAt"],
  ManagersOnAccountWhereInput: ["AND", "OR", "NOT", "accountId", "managersId", "account", "managers", "createdAt", "updatedAt"],
  ManagersOnAccountOrderByWithRelationAndSearchRelevanceInput: ["accountId", "managersId", "account", "managers", "createdAt", "updatedAt", "_relevance"],
  ManagersOnAccountWhereUniqueInput: ["accountId_managersId"],
  ManagersOnAccountOrderByWithAggregationInput: ["accountId", "managersId", "createdAt", "updatedAt", "_count", "_max", "_min"],
  ManagersOnAccountScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "accountId", "managersId", "createdAt", "updatedAt"],
  AddressWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "account", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "primaryaccountId", "deleted", "featuresOfBuisness", "phones", "rooms"],
  AddressOrderByWithRelationAndSearchRelevanceInput: ["id", "createdAt", "updatedAt", "account", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "primaryaccountId", "deleted", "featuresOfBuisness", "phones", "rooms", "_relevance"],
  AddressWhereUniqueInput: ["id", "primaryaccountId"],
  AddressOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted", "_count", "_max", "_min"],
  AddressScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted"],
  ContactAtAddressWhereInput: ["AND", "OR", "NOT", "accountId", "addressId", "account", "address", "jobTitle", "phone", "email", "emailId", "createdAt", "updatedAt", "deleted"],
  ContactAtAddressOrderByWithRelationAndSearchRelevanceInput: ["accountId", "addressId", "account", "address", "jobTitle", "phone", "email", "emailId", "createdAt", "updatedAt", "deleted", "_relevance"],
  ContactAtAddressWhereUniqueInput: ["accountId_addressId"],
  ContactAtAddressOrderByWithAggregationInput: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  ContactAtAddressScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  VenueStyleWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "address", "name", "details"],
  VenueStyleOrderByWithRelationAndSearchRelevanceInput: ["id", "createdAt", "updatedAt", "address", "name", "details", "_relevance"],
  VenueStyleWhereUniqueInput: ["id"],
  VenueStyleOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "details", "_count", "_max", "_min"],
  VenueStyleScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "details"],
  ...
  EmailOrderByWithRelationAndSearchRelevanceInput: ["id", "associatedContact", "domain", "domainId", "email", "account", "accountId", "verified", "public", "primary", "path", "copy", "notifyFrom", "imap_authUser", "imap_authPass", "imap_accessToken", "imap_authServer", "imap_host", "imap_port", "imap_secure", "imap_tslRejectUnauthorized", "imap_tslMinVersion", "imap_resyncDelay", "smtp_authUser", "smtp_authPass", "smtp_accessToken", "smtp_authServer", "smtp_host", "smtp_port", "smtp_secure", "smtp_tslRejectUnauthorized", "smtp_tslMinVersion", "oauth2_authorize", "oauth2_provider", "oauth2_authUser", "oauth2_accessToken", "oauth2_refreshToken", "oauth2_expires", "createdAt", "updatedAt", "deleted", "_relevance"],
  EmailWhereUniqueInput: ["id", "email"],
  EmailOrderByWithAggregationInput: ["id", "domainId", "email", "accountId", "verified", "public", "primary", "path", "copy", "notifyFrom", "imap_authUser", "imap_authPass", "imap_accessToken", "imap_authServer", "imap_host", "imap_port", "imap_secure", "imap_tslRejectUnauthorized", "imap_tslMinVersion", "imap_resyncDelay", "smtp_authUser", "smtp_authPass", "smtp_accessToken", "smtp_authServer", "smtp_host", "smtp_port", "smtp_secure", "smtp_tslRejectUnauthorized", "smtp_tslMinVersion", "oauth2_authorize", "oauth2_provider", "oauth2_authUser", "oauth2_accessToken", "oauth2_refreshToken", "oauth2_expires", "createdAt", "updatedAt", "deleted", "_count", "_avg", "_max", "_min", "_sum"],
  ...
  ApplicationWhereInput: ["AND", "OR", "NOT", "id", "name", "account", "accountId", "createdAt", "updatedAt", "deleted"],
  ApplicationOrderByWithRelationAndSearchRelevanceInput: ["id", "name", "account", "accountId", "createdAt", "updatedAt", "deleted", "_relevance"],
  ApplicationWhereUniqueInput: ["id"],
  ApplicationOrderByWithAggregationInput: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  ApplicationScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "accountId", "createdAt", "updatedAt", "deleted"],
  DomainWhereInput: ["AND", "OR", "NOT", "id", "domain", "verified", "dnsType", "linkedEmails", "data", "createdAt", "updatedAt", "deleted"],
  DomainOrderByWithRelationAndSearchRelevanceInput: ["id", "domain", "verified", "dnsType", "linkedEmails", "data", "createdAt", "updatedAt", "deleted", "_relevance"],
  DomainWhereUniqueInput: ["id", "domain"],
  DomainOrderByWithAggregationInput: ["id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  DomainScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted"],
  FeatureWhereInput: ["AND", "OR", "NOT", "id", "name", "type", "featureOfRoom", "featureOfAddress", "createdAt", "updatedAt", "deleted"],
  FeatureOrderByWithRelationAndSearchRelevanceInput: ["id", "name", "type", "featureOfRoom", "featureOfAddress", "createdAt", "updatedAt", "deleted", "_relevance"],
  FeatureWhereUniqueInput: ["id"],
  FeatureOrderByWithAggregationInput: ["id", "name", "type", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  FeatureScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "type", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomWhereInput: ["AND", "OR", "NOT", "roomId", "featureId", "feature", "room", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomOrderByWithRelationAndSearchRelevanceInput: ["roomId", "featureId", "feature", "room", "data", "createdAt", "updatedAt", "deleted", "_relevance"],
  FeatureOfRoomWhereUniqueInput: ["roomId_featureId"],
  FeatureOfRoomOrderByWithAggregationInput: ["roomId", "featureId", "data", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  FeatureOfRoomScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "roomId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressWhereInput: ["AND", "OR", "NOT", "addressId", "featureId", "feature", "address", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressOrderByWithRelationAndSearchRelevanceInput: ["addressId", "featureId", "feature", "address", "data", "createdAt", "updatedAt", "deleted", "_relevance"],
  FeatureOfAddressWhereUniqueInput: ["addressId_featureId"],
  FeatureOfAddressOrderByWithAggregationInput: ["addressId", "featureId", "data", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  FeatureOfAddressScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "addressId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  RoomWhereInput: ["AND", "OR", "NOT", "id", "featuresOfRoom", "createdAt", "updatedAt", "deleted", "address", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "arrangements"],
  RoomOrderByWithRelationAndSearchRelevanceInput: ["id", "featuresOfRoom", "createdAt", "updatedAt", "deleted", "address", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "arrangements", "_relevance"],
  RoomWhereUniqueInput: ["id"],
  RoomOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "_count", "_max", "_min"],
  RoomScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  FilesWhereInput: ["AND", "OR", "NOT", "id", "name", "rtw", "rtwId", "account", "createdAt", "updatedAt", "deleted"],
  FilesOrderByWithRelationAndSearchRelevanceInput: ["id", "name", "rtw", "rtwId", "account", "createdAt", "updatedAt", "deleted", "_relevance"],
  FilesWhereUniqueInput: ["id"],
  FilesOrderByWithAggregationInput: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  FilesScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  RTWWhereInput: ["AND", "OR", "NOT", "id", "files", "name", "active", "startDate", "endDate", "account", "accountId", "createdAt", "updatedAt", "deleted"],
  RTWOrderByWithRelationAndSearchRelevanceInput: ["id", "files", "name", "active", "startDate", "endDate", "account", "accountId", "createdAt", "updatedAt", "deleted", "_relevance"],
  RTWWhereUniqueInput: ["id"],
  RTWOrderByWithAggregationInput: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  RTWScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  PhoneWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "account", "accountId", "address", "addressId", "phone", "public"],
  PhoneOrderByWithRelationAndSearchRelevanceInput: ["id", "createdAt", "updatedAt", "deleted", "account", "accountId", "address", "addressId", "phone", "public", "_relevance"],
  PhoneWhereUniqueInput: ["id", "phone"],
  PhoneOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public", "_count", "_max", "_min"],
  PhoneScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  ArrangementOfRoomWhereInput: ["AND", "OR", "NOT", "roomId", "arrangementId", "arrangement", "room", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomOrderByWithRelationAndSearchRelevanceInput: ["roomId", "arrangementId", "arrangement", "room", "capacity", "details", "createdAt", "updatedAt", "_relevance"],
  ArrangementOfRoomWhereUniqueInput: ["roomId_arrangementId"],
  ArrangementOfRoomOrderByWithAggregationInput: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  ArrangementOfRoomScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "room", "name", "icon", "details"],
  ArrangementOrderByWithRelationAndSearchRelevanceInput: ["id", "createdAt", "updatedAt", "room", "name", "icon", "details", "_relevance"],
  ArrangementWhereUniqueInput: ["id"],
  ArrangementOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "name", "icon", "details", "_count", "_max", "_min"],
  ArrangementScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "icon", "details"],
  SIABadgeWhereInput: ["AND", "OR", "NOT", "id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "siaChecks", "account", "account_id"],
  SIABadgeOrderByWithRelationAndSearchRelevanceInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "siaChecks", "account", "account_id", "_relevance"],
  SIABadgeWhereUniqueInput: ["id"],
  SIABadgeOrderByWithAggregationInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id", "_count", "_avg", "_max", "_min", "_sum"],
  SIABadgeScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  SIACheckWhereInput: ["AND", "OR", "NOT", "id", "badge", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactions", "transactionId"],
  SIACheckOrderByWithRelationAndSearchRelevanceInput: ["id", "badge", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactions", "transactionId", "_relevance"],
  SIACheckWhereUniqueInput: ["id"],
  SIACheckOrderByWithAggregationInput: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId", "_count", "_avg", "_max", "_min", "_sum"],
  SIACheckScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  StatusOnAccountWhereInput: ["AND", "OR", "NOT", "statusId", "accountId", "status", "account", "createdAt", "updatedAt", "deleted"],
  StatusOnAccountOrderByWithRelationAndSearchRelevanceInput: ["statusId", "accountId", "status", "account", "createdAt", "updatedAt", "deleted", "_relevance"],
  StatusOnAccountWhereUniqueInput: ["statusId_accountId"],
  StatusOnAccountOrderByWithAggregationInput: ["statusId", "accountId", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  StatusOnAccountScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  StatusWhereInput: ["AND", "OR", "NOT", "id", "name", "account", "createdAt", "updatedAt", "deleted"],
  StatusOrderByWithRelationAndSearchRelevanceInput: ["id", "name", "account", "createdAt", "updatedAt", "deleted", "_relevance"],
  StatusWhereUniqueInput: ["id"],
  StatusOrderByWithAggregationInput: ["id", "name", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  StatusScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "createdAt", "updatedAt", "deleted"],
  SubscriptionWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "name", "cost", "details", "accounts"],
  SubscriptionOrderByWithRelationAndSearchRelevanceInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details", "accounts", "_relevance"],
  SubscriptionWhereUniqueInput: ["id", "name"],
  SubscriptionOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details", "_count", "_max", "_min"],
  SubscriptionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  SubscriptionOnAccountWhereInput: ["AND", "OR", "NOT", "subscriptionId", "subscription", "account", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountOrderByWithRelationAndSearchRelevanceInput: ["subscriptionId", "subscription", "account", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted", "_relevance"],
  SubscriptionOnAccountWhereUniqueInput: ["accountId_subscriptionId"],
  SubscriptionOnAccountOrderByWithAggregationInput: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted", "_count", "_max", "_min"],
  SubscriptionOnAccountScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  TransactionWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "account", "accountId", "SIACheck", "data"],
  TransactionOrderByWithRelationAndSearchRelevanceInput: ["id", "createdAt", "updatedAt", "deleted", "account", "accountId", "SIACheck", "data", "_relevance"],
  TransactionWhereUniqueInput: ["id"],
  TransactionOrderByWithAggregationInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "data", "_count", "_max", "_min"],
  TransactionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "accountId", "data"],
  AccountCreateInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountUpdateInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountCreateManyInput: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  AccountUpdateManyMutationInput: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  TokenCreateInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "account"],
  TokenUpdateInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "account"],
  TokenCreateManyInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  TokenUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry"],
  SubuserOnAccountCreateInput: ["account", "subuser", "createdAt", "updatedAt"],
  SubuserOnAccountUpdateInput: ["account", "subuser", "createdAt", "updatedAt"],
  SubuserOnAccountCreateManyInput: ["accountId", "subuserId", "createdAt", "updatedAt"],
  SubuserOnAccountUpdateManyMutationInput: ["createdAt", "updatedAt"],
  EmployersOnAccountCreateInput: ["account", "employer", "createdAt", "updatedAt"],
  EmployersOnAccountUpdateInput: ["account", "employer", "createdAt", "updatedAt"],
  EmployersOnAccountCreateManyInput: ["accountId", "employerId", "createdAt", "updatedAt"],
  EmployersOnAccountUpdateManyMutationInput: ["createdAt", "updatedAt"],
  ManagersOnAccountCreateInput: ["account", "managers", "createdAt", "updatedAt"],
  ManagersOnAccountUpdateInput: ["account", "managers", "createdAt", "updatedAt"],
  ManagersOnAccountCreateManyInput: ["accountId", "managersId", "createdAt", "updatedAt"],
  ManagersOnAccountUpdateManyMutationInput: ["createdAt", "updatedAt"],
  AddressCreateInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones", "rooms"],
  AddressUpdateInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones", "rooms"],
  AddressCreateManyInput: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted"],
  AddressUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "deleted"],
  ContactAtAddressCreateInput: ["account", "address", "jobTitle", "phone", "email", "createdAt", "updatedAt", "deleted"],
  ContactAtAddressUpdateInput: ["account", "address", "jobTitle", "phone", "email", "createdAt", "updatedAt", "deleted"],
  ContactAtAddressCreateManyInput: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  ContactAtAddressUpdateManyMutationInput: ["jobTitle", "phone", "createdAt", "updatedAt", "deleted"],
  VenueStyleCreateInput: ["id", "createdAt", "updatedAt", "address", "name", "details"],
  VenueStyleUpdateInput: ["id", "createdAt", "updatedAt", "address", "name", "details"],
  VenueStyleCreateManyInput: ["id", "createdAt", "updatedAt", "name", "details"],
  VenueStyleUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "name", "details"],
  ...
  ApplicationCreateInput: ["id", "name", "account", "createdAt", "updatedAt", "deleted"],
  ApplicationUpdateInput: ["id", "name", "account", "createdAt", "updatedAt", "deleted"],
  ApplicationCreateManyInput: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted"],
  ApplicationUpdateManyMutationInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  DomainCreateInput: ["id", "domain", "verified", "dnsType", "linkedEmails", "data", "createdAt", "updatedAt", "deleted"],
  DomainUpdateInput: ["id", "domain", "verified", "dnsType", "linkedEmails", "data", "createdAt", "updatedAt", "deleted"],
  DomainCreateManyInput: ["id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted"],
  DomainUpdateManyMutationInput: ["id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted"],
  FeatureCreateInput: ["id", "name", "type", "featureOfRoom", "featureOfAddress", "createdAt", "updatedAt", "deleted"],
  FeatureUpdateInput: ["id", "name", "type", "featureOfRoom", "featureOfAddress", "createdAt", "updatedAt", "deleted"],
  FeatureCreateManyInput: ["id", "name", "type", "createdAt", "updatedAt", "deleted"],
  FeatureUpdateManyMutationInput: ["id", "name", "type", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomCreateInput: ["feature", "room", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomUpdateInput: ["feature", "room", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomCreateManyInput: ["roomId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomUpdateManyMutationInput: ["data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressCreateInput: ["feature", "address", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressUpdateInput: ["feature", "address", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressCreateManyInput: ["addressId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressUpdateManyMutationInput: ["data", "createdAt", "updatedAt", "deleted"],
  RoomCreateInput: ["id", "featuresOfRoom", "createdAt", "updatedAt", "deleted", "address", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "arrangements"],
  RoomUpdateInput: ["id", "featuresOfRoom", "createdAt", "updatedAt", "deleted", "address", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "arrangements"],
  RoomCreateManyInput: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  RoomUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "deleted", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  FilesCreateInput: ["id", "name", "rtw", "account", "createdAt", "updatedAt", "deleted"],
  FilesUpdateInput: ["id", "name", "rtw", "account", "createdAt", "updatedAt", "deleted"],
  FilesCreateManyInput: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  FilesUpdateManyMutationInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  RTWCreateInput: ["id", "files", "name", "active", "startDate", "endDate", "account", "createdAt", "updatedAt", "deleted"],
  RTWUpdateInput: ["id", "files", "name", "active", "startDate", "endDate", "account", "createdAt", "updatedAt", "deleted"],
  RTWCreateManyInput: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  RTWUpdateManyMutationInput: ["id", "name", "active", "startDate", "endDate", "createdAt", "updatedAt", "deleted"],
  PhoneCreateInput: ["id", "createdAt", "updatedAt", "deleted", "account", "address", "phone", "public"],
  PhoneUpdateInput: ["id", "createdAt", "updatedAt", "deleted", "account", "address", "phone", "public"],
  PhoneCreateManyInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  PhoneUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "deleted", "phone", "public"],
  ArrangementOfRoomCreateInput: ["arrangement", "room", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomUpdateInput: ["arrangement", "room", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomCreateManyInput: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomUpdateManyMutationInput: ["capacity", "details", "createdAt", "updatedAt"],
  ArrangementCreateInput: ["id", "createdAt", "updatedAt", "room", "name", "icon", "details"],
  ArrangementUpdateInput: ["id", "createdAt", "updatedAt", "room", "name", "icon", "details"],
  ArrangementCreateManyInput: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  ArrangementUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  SIABadgeCreateInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "siaChecks", "account"],
  SIABadgeUpdateInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "siaChecks", "account"],
  SIABadgeCreateManyInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  SIABadgeUpdateManyMutationInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted"],
  SIACheckCreateInput: ["id", "badge", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactions"],
  SIACheckUpdateInput: ["id", "badge", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactions"],
  SIACheckCreateManyInput: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  SIACheckUpdateManyMutationInput: ["id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error"],
  StatusOnAccountCreateInput: ["status", "account", "createdAt", "updatedAt", "deleted"],
  StatusOnAccountUpdateInput: ["status", "account", "createdAt", "updatedAt", "deleted"],
  StatusOnAccountCreateManyInput: ["statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  StatusOnAccountUpdateManyMutationInput: ["createdAt", "updatedAt", "deleted"],
  StatusCreateInput: ["id", "name", "account", "createdAt", "updatedAt", "deleted"],
  StatusUpdateInput: ["id", "name", "account", "createdAt", "updatedAt", "deleted"],
  StatusCreateManyInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  StatusUpdateManyMutationInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  SubscriptionCreateInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details", "accounts"],
  SubscriptionUpdateInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details", "accounts"],
  SubscriptionCreateManyInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  SubscriptionUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  SubscriptionOnAccountCreateInput: ["subscription", "account", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountUpdateInput: ["subscription", "account", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountCreateManyInput: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountUpdateManyMutationInput: ["active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  TransactionCreateInput: ["id", "createdAt", "updatedAt", "deleted", "account", "SIACheck", "data"],
  TransactionUpdateInput: ["id", "createdAt", "updatedAt", "deleted", "account", "SIACheck", "data"],
  TransactionCreateManyInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "data"],
  TransactionUpdateManyMutationInput: ["id", "createdAt", "updatedAt", "deleted", "data"],
  ...
  AccountCountOrderByAggregateInput: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  AccountMaxOrderByAggregateInput: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  AccountMinOrderByAggregateInput: ["id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  ...
  TokenCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  TokenMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  TokenMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  ...
  SubuserOnAccountCountOrderByAggregateInput: ["accountId", "subuserId", "createdAt", "updatedAt"],
  SubuserOnAccountMaxOrderByAggregateInput: ["accountId", "subuserId", "createdAt", "updatedAt"],
  SubuserOnAccountMinOrderByAggregateInput: ["accountId", "subuserId", "createdAt", "updatedAt"],
  ...
  EmployersOnAccountCountOrderByAggregateInput: ["accountId", "employerId", "createdAt", "updatedAt"],
  EmployersOnAccountMaxOrderByAggregateInput: ["accountId", "employerId", "createdAt", "updatedAt"],
  EmployersOnAccountMinOrderByAggregateInput: ["accountId", "employerId", "createdAt", "updatedAt"],
  ...
  ManagersOnAccountCountOrderByAggregateInput: ["accountId", "managersId", "createdAt", "updatedAt"],
  ManagersOnAccountMaxOrderByAggregateInput: ["accountId", "managersId", "createdAt", "updatedAt"],
  ManagersOnAccountMinOrderByAggregateInput: ["accountId", "managersId", "createdAt", "updatedAt"],
  ...
  AddressCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted"],
  AddressMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "features", "public", "primaryaccountId", "deleted"],
  AddressMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "features", "public", "primaryaccountId", "deleted"],
  ...
  ContactAtAddressCountOrderByAggregateInput: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  ContactAtAddressMaxOrderByAggregateInput: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  ContactAtAddressMinOrderByAggregateInput: ["accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  VenueStyleOrderByRelevanceInput: ["fields", "sort", "search"],
  VenueStyleCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "details"],
  VenueStyleMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "details"],
  VenueStyleMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "details"],
  ...
  ApplicationCountOrderByAggregateInput: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted"],
  ApplicationMaxOrderByAggregateInput: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted"],
  ApplicationMinOrderByAggregateInput: ["id", "name", "accountId", "createdAt", "updatedAt", "deleted"],
  ...
  DomainCountOrderByAggregateInput: ["id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted"],
  DomainMaxOrderByAggregateInput: ["id", "domain", "verified", "dnsType", "createdAt", "updatedAt", "deleted"],
  DomainMinOrderByAggregateInput: ["id", "domain", "verified", "dnsType", "createdAt", "updatedAt", "deleted"],
  ...
  FeatureCountOrderByAggregateInput: ["id", "name", "type", "createdAt", "updatedAt", "deleted"],
  FeatureMaxOrderByAggregateInput: ["id", "name", "type", "createdAt", "updatedAt", "deleted"],
  FeatureMinOrderByAggregateInput: ["id", "name", "type", "createdAt", "updatedAt", "deleted"],
  ...
  FeatureOfRoomCountOrderByAggregateInput: ["roomId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomMaxOrderByAggregateInput: ["roomId", "featureId", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomMinOrderByAggregateInput: ["roomId", "featureId", "createdAt", "updatedAt", "deleted"],
  ...
  FeatureOfAddressCountOrderByAggregateInput: ["addressId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressMaxOrderByAggregateInput: ["addressId", "featureId", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressMinOrderByAggregateInput: ["addressId", "featureId", "createdAt", "updatedAt", "deleted"],
  ...
  RoomCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  RoomMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  RoomMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  ...
  FilesCountOrderByAggregateInput: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  FilesMaxOrderByAggregateInput: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  FilesMinOrderByAggregateInput: ["id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  RTWOrderByRelevanceInput: ["fields", "sort", "search"],
  RTWCountOrderByAggregateInput: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  RTWMaxOrderByAggregateInput: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  RTWMinOrderByAggregateInput: ["id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  PhoneOrderByRelevanceInput: ["fields", "sort", "search"],
  PhoneCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  PhoneMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  PhoneMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  ...
  ArrangementOfRoomCountOrderByAggregateInput: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomAvgOrderByAggregateInput: ["capacity"],
  ArrangementOfRoomMaxOrderByAggregateInput: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomMinOrderByAggregateInput: ["roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomSumOrderByAggregateInput: ["capacity"],
  ArrangementOrderByRelevanceInput: ["fields", "sort", "search"],
  ArrangementCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  ArrangementMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  ArrangementMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  ...
  SIABadgeCountOrderByAggregateInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  SIABadgeAvgOrderByAggregateInput: ["id"],
  SIABadgeMaxOrderByAggregateInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  SIABadgeMinOrderByAggregateInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  ...
  SIACheckCountOrderByAggregateInput: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  SIACheckAvgOrderByAggregateInput: ["sia_id"],
  SIACheckMaxOrderByAggregateInput: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  SIACheckMinOrderByAggregateInput: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  ...
  StatusOnAccountCountOrderByAggregateInput: ["statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  StatusOnAccountMaxOrderByAggregateInput: ["statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  StatusOnAccountMinOrderByAggregateInput: ["statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  StatusOrderByRelevanceInput: ["fields", "sort", "search"],
  StatusCountOrderByAggregateInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  StatusMaxOrderByAggregateInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  StatusMinOrderByAggregateInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  SubscriptionOrderByRelevanceInput: ["fields", "sort", "search"],
  SubscriptionCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  SubscriptionMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  SubscriptionMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "name", "cost", "details"],
  ...
  SubscriptionOnAccountCountOrderByAggregateInput: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountMaxOrderByAggregateInput: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountMinOrderByAggregateInput: ["subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  TransactionOrderByRelevanceInput: ["fields", "sort", "search"],
  TransactionCountOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "data"],
  TransactionMaxOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "accountId"],
  TransactionMinOrderByAggregateInput: ["id", "createdAt", "updatedAt", "deleted", "accountId"],
  ...
  EmployersOnAccountCreateWithoutAccountInput: ["employer", "createdAt", "updatedAt"],
  ...
  EmployersOnAccountCreateWithoutEmployerInput: ["account", "createdAt", "updatedAt"],
  ...
  SubuserOnAccountCreateWithoutAccountInput: ["subuser", "createdAt", "updatedAt"],
  ...
  SubuserOnAccountCreateWithoutSubuserInput: ["account", "createdAt", "updatedAt"],
  ...
  ManagersOnAccountCreateWithoutAccountInput: ["managers", "createdAt", "updatedAt"],
  ...
  ManagersOnAccountCreateWithoutManagersInput: ["account", "createdAt", "updatedAt"],
  ...
  TokenCreateWithoutAccountInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry"],
  TokenCreateOrConnectWithoutAccountInput: ["where", "create"],
  TokenCreateManyAccountInputEnvelope: ["data", "skipDuplicates"],
  AddressCreateWithoutPrimaryAccountInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "deleted", "featuresOfBuisness", "phones", "rooms"],
  AddressCreateOrConnectWithoutPrimaryAccountInput: ["where", "create"],
  AddressCreateWithoutAccountInput: ["id", "createdAt", "updatedAt", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones", "rooms"],
  AddressCreateOrConnectWithoutAccountInput: ["where", "create"],
  AddressCreateManyAccountInputEnvelope: ["data", "skipDuplicates"],
  ContactAtAddressCreateWithoutAccountInput: ["address", "jobTitle", "phone", "email", "createdAt", "updatedAt", "deleted"],
  ...
  ApplicationCreateWithoutAccountInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  ...
  FilesCreateWithoutAccountInput: ["id", "name", "rtw", "createdAt", "updatedAt", "deleted"],
  FilesCreateOrConnectWithoutAccountInput: ["where", "create"],
  PhoneCreateWithoutAccountInput: ["id", "createdAt", "updatedAt", "deleted", "address", "phone", "public"],
  PhoneCreateOrConnectWithoutAccountInput: ["where", "create"],
  PhoneCreateManyAccountInputEnvelope: ["data", "skipDuplicates"],
  RTWCreateWithoutAccountInput: ["id", "files", "name", "active", "startDate", "endDate", "createdAt", "updatedAt", "deleted"],
  RTWCreateOrConnectWithoutAccountInput: ["where", "create"],
  RTWCreateManyAccountInputEnvelope: ["data", "skipDuplicates"],
  SIABadgeCreateWithoutAccountInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "siaChecks"],
  SIABadgeCreateOrConnectWithoutAccountInput: ["where", "create"],
  SIABadgeCreateManyAccountInputEnvelope: ["data", "skipDuplicates"],
  StatusOnAccountCreateWithoutAccountInput: ["status", "createdAt", "updatedAt", "deleted"],
  ...
  SubscriptionOnAccountCreateWithoutAccountInput: ["subscription", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  ...
  TransactionCreateWithoutAccountInput: ["id", "createdAt", "updatedAt", "deleted", "SIACheck", "data"],
  ...
  EmployersOnAccountScalarWhereInput: ["AND", "OR", "NOT", "accountId", "employerId", "createdAt", "updatedAt"],
  ...
  SubuserOnAccountScalarWhereInput: ["AND", "OR", "NOT", "accountId", "subuserId", "createdAt", "updatedAt"],
  ...
  ManagersOnAccountScalarWhereInput: ["AND", "OR", "NOT", "accountId", "managersId", "createdAt", "updatedAt"],
  ...
  TokenScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "type", "value", "valid", "expiry", "apiToken"],
  AddressUpsertWithoutPrimaryAccountInput: ["update", "create"],
  AddressUpdateWithoutPrimaryAccountInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "deleted", "featuresOfBuisness", "phones", "rooms"],
  ...
  AddressScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "accountId", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted"],
  ...
  ContactAtAddressScalarWhereInput: ["AND", "OR", "NOT", "accountId", "addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  ...
  ApplicationScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "accountId", "createdAt", "updatedAt", "deleted"],
  ...
  FilesScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "rtwId", "createdAt", "updatedAt", "deleted"],
  ...
  PhoneScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "accountId", "addressId", "phone", "public"],
  ...
  RTWScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "active", "startDate", "endDate", "accountId", "createdAt", "updatedAt", "deleted"],
  ...
  SIABadgeScalarWhereInput: ["AND", "OR", "NOT", "id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account_id"],
  ...
  StatusOnAccountScalarWhereInput: ["AND", "OR", "NOT", "statusId", "accountId", "createdAt", "updatedAt", "deleted"],
  ...
  SubscriptionOnAccountScalarWhereInput: ["AND", "OR", "NOT", "subscriptionId", "accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  ...
  AccountUpdateWithoutAccountsInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountUpsertWithoutManagersInput: ["update", "create"],
  AccountUpdateWithoutManagersInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountCreateWithoutAddressesInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountCreateOrConnectWithoutAddressesInput: ["where", "create"],
  ContactAtAddressCreateWithoutAddressInput: ["account", "jobTitle", "phone", "email", "createdAt", "updatedAt", "deleted"],
  ...
  VenueStyleCreateWithoutAddressInput: ["id", "createdAt", "updatedAt", "name", "details"],
  VenueStyleCreateOrConnectWithoutAddressInput: ["where", "create"],
  AccountCreateWithoutPrimaryAddressInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountCreateOrConnectWithoutPrimaryAddressInput: ["where", "create"],
  FeatureOfAddressCreateWithoutAddressInput: ["feature", "data", "createdAt", "updatedAt", "deleted"],
  ...
  PhoneCreateWithoutAddressInput: ["id", "createdAt", "updatedAt", "deleted", "account", "phone", "public"],
  PhoneCreateOrConnectWithoutAddressInput: ["where", "create"],
  PhoneCreateManyAddressInputEnvelope: ["data", "skipDuplicates"],
  RoomCreateWithoutAddressInput: ["id", "featuresOfRoom", "createdAt", "updatedAt", "deleted", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "arrangements"],
  ...
  AccountUpdateWithoutAddressesInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  ...
  VenueStyleScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "name", "details"],
  ...
  FeatureOfAddressScalarWhereInput: ["AND", "OR", "NOT", "addressId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  ...
  RoomScalarWhereInput: ["AND", "OR", "NOT", "id", "createdAt", "updatedAt", "deleted", "addressId", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  AccountCreateWithoutContactOfAddressInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountCreateOrConnectWithoutContactOfAddressInput: ["where", "create"],
  AddressCreateWithoutContactsInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones", "rooms"],
  ...
  AddressUpdateWithoutContactsInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones", "rooms"],
  ...
  AddressCreateWithoutVenueStyleInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones", "rooms"],
  ...
  ContactAtAddressCreateWithoutEmailInput: ["account", "address", "jobTitle", "phone", "createdAt", "updatedAt", "deleted"],
  ...
  DomainCreateWithoutLinkedEmailsInput: ["id", "domain", "verified", "dnsType", "data", "createdAt", "updatedAt", "deleted"],
  DomainCreateOrConnectWithoutLinkedEmailsInput: ["where", "create"],
  AccountCreateWithoutEmailsInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "files", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  ...
  FeatureOfRoomCreateWithoutFeatureInput: ["room", "data", "createdAt", "updatedAt", "deleted"],
  ...
  FeatureOfAddressCreateWithoutFeatureInput: ["address", "data", "createdAt", "updatedAt", "deleted"],
  ...
  FeatureOfRoomScalarWhereInput: ["AND", "OR", "NOT", "roomId", "featureId", "data", "createdAt", "updatedAt", "deleted"],
  ...
  FeatureCreateWithoutFeatureOfRoomInput: ["id", "name", "type", "featureOfAddress", "createdAt", "updatedAt", "deleted"],
  FeatureCreateOrConnectWithoutFeatureOfRoomInput: ["where", "create"],
  RoomCreateWithoutFeaturesOfRoomInput: ["id", "createdAt", "updatedAt", "deleted", "address", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "arrangements"],
  RoomCreateOrConnectWithoutFeaturesOfRoomInput: ["where", "create"],
  FeatureUpsertWithoutFeatureOfRoomInput: ["update", "create"],
  FeatureUpdateWithoutFeatureOfRoomInput: ["id", "name", "type", "featureOfAddress", "createdAt", "updatedAt", "deleted"],
  RoomUpsertWithoutFeaturesOfRoomInput: ["update", "create"],
  RoomUpdateWithoutFeaturesOfRoomInput: ["id", "createdAt", "updatedAt", "deleted", "address", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "arrangements"],
  FeatureCreateWithoutFeatureOfAddressInput: ["id", "name", "type", "featureOfRoom", "createdAt", "updatedAt", "deleted"],
  FeatureCreateOrConnectWithoutFeatureOfAddressInput: ["where", "create"],
  AddressCreateWithoutFeaturesOfBuisnessInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "phones", "rooms"],
  AddressCreateOrConnectWithoutFeaturesOfBuisnessInput: ["where", "create"],
  FeatureUpsertWithoutFeatureOfAddressInput: ["update", "create"],
  FeatureUpdateWithoutFeatureOfAddressInput: ["id", "name", "type", "featureOfRoom", "createdAt", "updatedAt", "deleted"],
  AddressUpsertWithoutFeaturesOfBuisnessInput: ["update", "create"],
  AddressUpdateWithoutFeaturesOfBuisnessInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "phones", "rooms"],
  FeatureOfRoomCreateWithoutRoomInput: ["feature", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomCreateOrConnectWithoutRoomInput: ["where", "create"],
  FeatureOfRoomCreateManyRoomInputEnvelope: ["data", "skipDuplicates"],
  AddressCreateWithoutRoomsInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones"],
  AddressCreateOrConnectWithoutRoomsInput: ["where", "create"],
  ArrangementOfRoomCreateWithoutRoomInput: ["arrangement", "capacity", "details", "createdAt", "updatedAt"],
  ...
  AddressUpdateWithoutRoomsInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones"],
  ...
  ArrangementOfRoomScalarWhereInput: ["AND", "OR", "NOT", "roomId", "arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  RTWCreateWithoutFilesInput: ["id", "name", "active", "startDate", "endDate", "account", "createdAt", "updatedAt", "deleted"],
  ...
  RTWUpdateWithoutFilesInput: ["id", "name", "active", "startDate", "endDate", "account", "createdAt", "updatedAt", "deleted"],
  ...
  AccountScalarWhereInput: ["AND", "OR", "NOT", "id", "username", "accountType", "subsciption", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "deleted"],
  FilesCreateWithoutRtwInput: ["id", "name", "account", "createdAt", "updatedAt", "deleted"],
  FilesCreateOrConnectWithoutRtwInput: ["where", "create"],
  FilesCreateManyRtwInputEnvelope: ["data", "skipDuplicates"],
  AccountCreateWithoutRtwInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "sia", "Status", "subscription", "transactions"],
  ...
  AccountUpdateWithoutRtwInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "sia", "Status", "subscription", "transactions"],
  AccountCreateWithoutPhonesInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "rtw", "sia", "Status", "subscription", "transactions"],
  AccountCreateOrConnectWithoutPhonesInput: ["where", "create"],
  AddressCreateWithoutPhonesInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "rooms"],
  AddressCreateOrConnectWithoutPhonesInput: ["where", "create"],
  AccountUpsertWithoutPhonesInput: ["update", "create"],
  AccountUpdateWithoutPhonesInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "rtw", "sia", "Status", "subscription", "transactions"],
  AddressUpsertWithoutPhonesInput: ["update", "create"],
  AddressUpdateWithoutPhonesInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "rooms"],
  ArrangementCreateWithoutRoomInput: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  ArrangementCreateOrConnectWithoutRoomInput: ["where", "create"],
  RoomCreateWithoutArrangementsInput: ["id", "featuresOfRoom", "createdAt", "updatedAt", "deleted", "address", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  RoomCreateOrConnectWithoutArrangementsInput: ["where", "create"],
  ArrangementUpsertWithoutRoomInput: ["update", "create"],
  ArrangementUpdateWithoutRoomInput: ["id", "createdAt", "updatedAt", "name", "icon", "details"],
  RoomUpsertWithoutArrangementsInput: ["update", "create"],
  RoomUpdateWithoutArrangementsInput: ["id", "featuresOfRoom", "createdAt", "updatedAt", "deleted", "address", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  ArrangementOfRoomCreateWithoutArrangementInput: ["room", "capacity", "details", "createdAt", "updatedAt"],
  ...
  SIACheckScalarWhereInput: ["AND", "OR", "NOT", "id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  AccountUpsertWithoutSiaInput: ["update", "create"],
  AccountUpdateWithoutSiaInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "Status", "subscription", "transactions"],
  SIABadgeCreateWithoutSiaChecksInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account"],
  SIABadgeCreateOrConnectWithoutSiaChecksInput: ["where", "create"],
  TransactionCreateWithoutSIACheckInput: ["id", "createdAt", "updatedAt", "deleted", "account", "data"],
  TransactionCreateOrConnectWithoutSIACheckInput: ["where", "create"],
  SIABadgeUpsertWithoutSiaChecksInput: ["update", "create"],
  SIABadgeUpdateWithoutSiaChecksInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "account"],
  TransactionUpsertWithoutSIACheckInput: ["update", "create"],
  TransactionUpdateWithoutSIACheckInput: ["id", "createdAt", "updatedAt", "deleted", "account", "data"],
  StatusCreateWithoutAccountInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  StatusCreateOrConnectWithoutAccountInput: ["where", "create"],
  AccountCreateWithoutStatusInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "subscription", "transactions"],
  AccountCreateOrConnectWithoutStatusInput: ["where", "create"],
  StatusUpsertWithoutAccountInput: ["update", "create"],
  StatusUpdateWithoutAccountInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  AccountUpsertWithoutStatusInput: ["update", "create"],
  AccountUpdateWithoutStatusInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "subscription", "transactions"],
  StatusOnAccountCreateWithoutStatusInput: ["account", "createdAt", "updatedAt", "deleted"],
  ...
  SubscriptionOnAccountCreateWithoutSubscriptionInput: ["account", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  ...
  AccountUpdateWithoutTransactionsInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "files", "phones", "rtw", "sia", "Status", "subscription"],
  ...
  EmployersOnAccountCreateManyAccountInput: ["employerId", "createdAt", "updatedAt"],
  EmployersOnAccountCreateManyEmployerInput: ["accountId", "createdAt", "updatedAt"],
  SubuserOnAccountCreateManyAccountInput: ["subuserId", "createdAt", "updatedAt"],
  SubuserOnAccountCreateManySubuserInput: ["accountId", "createdAt", "updatedAt"],
  ManagersOnAccountCreateManyAccountInput: ["managersId", "createdAt", "updatedAt"],
  ManagersOnAccountCreateManyManagersInput: ["accountId", "createdAt", "updatedAt"],
  TokenCreateManyAccountInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry"],
  AddressCreateManyAccountInput: ["id", "createdAt", "updatedAt", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "website", "hoursOfOperation", "features", "details", "public", "primaryaccountId", "deleted"],
  ContactAtAddressCreateManyAccountInput: ["addressId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  ApplicationCreateManyAccountInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  ...
  PhoneCreateManyAccountInput: ["id", "createdAt", "updatedAt", "deleted", "addressId", "phone", "public"],
  RTWCreateManyAccountInput: ["id", "name", "active", "startDate", "endDate", "createdAt", "updatedAt", "deleted"],
  SIABadgeCreateManyAccountInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted"],
  StatusOnAccountCreateManyAccountInput: ["statusId", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountCreateManyAccountInput: ["subscriptionId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  TransactionCreateManyAccountInput: ["id", "createdAt", "updatedAt", "deleted", "data"],
  EmployersOnAccountUpdateWithoutAccountInput: ["employer", "createdAt", "updatedAt"],
  EmployersOnAccountUpdateWithoutEmployerInput: ["account", "createdAt", "updatedAt"],
  SubuserOnAccountUpdateWithoutAccountInput: ["subuser", "createdAt", "updatedAt"],
  SubuserOnAccountUpdateWithoutSubuserInput: ["account", "createdAt", "updatedAt"],
  ManagersOnAccountUpdateWithoutAccountInput: ["managers", "createdAt", "updatedAt"],
  ManagersOnAccountUpdateWithoutManagersInput: ["account", "createdAt", "updatedAt"],
  TokenUpdateWithoutAccountInput: ["id", "createdAt", "updatedAt", "type", "value", "valid", "expiry"],
  AddressUpdateWithoutAccountInput: ["id", "createdAt", "updatedAt", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "venueStyle", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones", "rooms"],
  ContactAtAddressUpdateWithoutAccountInput: ["address", "jobTitle", "phone", "email", "createdAt", "updatedAt", "deleted"],
  ApplicationUpdateWithoutAccountInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  EmailUpdateWithoutAccountInput: ["id", "associatedContact", "domain", "email", "verified", "public", "primary", "path", "copy", "notifyFrom", "imap_authUser", "imap_authPass", "imap_accessToken", "imap_authServer", "imap_host", "imap_port", "imap_secure", "imap_tslRejectUnauthorized", "imap_tslMinVersion", "imap_resyncDelay", "smtp_authUser", "smtp_authPass", "smtp_accessToken", "smtp_authServer", "smtp_host", "smtp_port", "smtp_secure", "smtp_tslRejectUnauthorized", "smtp_tslMinVersion", "oauth2_authorize", "oauth2_provider", "oauth2_authUser", "oauth2_accessToken", "oauth2_refreshToken", "oauth2_expires", "createdAt", "updatedAt", "deleted"],
  FilesUpdateWithoutAccountInput: ["id", "name", "rtw", "createdAt", "updatedAt", "deleted"],
  PhoneUpdateWithoutAccountInput: ["id", "createdAt", "updatedAt", "deleted", "address", "phone", "public"],
  RTWUpdateWithoutAccountInput: ["id", "files", "name", "active", "startDate", "endDate", "createdAt", "updatedAt", "deleted"],
  SIABadgeUpdateWithoutAccountInput: ["id", "licenseSector", "type", "licenseExplanation", "additionalTerms", "createdAt", "active", "expiry", "updatedAt", "deleted", "siaChecks"],
  StatusOnAccountUpdateWithoutAccountInput: ["status", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountUpdateWithoutAccountInput: ["subscription", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  TransactionUpdateWithoutAccountInput: ["id", "createdAt", "updatedAt", "deleted", "SIACheck", "data"],
  ContactAtAddressCreateManyAddressInput: ["accountId", "jobTitle", "phone", "emailId", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressCreateManyAddressInput: ["featureId", "data", "createdAt", "updatedAt", "deleted"],
  PhoneCreateManyAddressInput: ["id", "createdAt", "updatedAt", "deleted", "accountId", "phone", "public"],
  RoomCreateManyAddressInput: ["id", "createdAt", "updatedAt", "deleted", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height"],
  ContactAtAddressUpdateWithoutAddressInput: ["account", "jobTitle", "phone", "email", "createdAt", "updatedAt", "deleted"],
  VenueStyleUpdateWithoutAddressInput: ["id", "createdAt", "updatedAt", "name", "details"],
  FeatureOfAddressUpdateWithoutAddressInput: ["feature", "data", "createdAt", "updatedAt", "deleted"],
  PhoneUpdateWithoutAddressInput: ["id", "createdAt", "updatedAt", "deleted", "account", "phone", "public"],
  RoomUpdateWithoutAddressInput: ["id", "featuresOfRoom", "createdAt", "updatedAt", "deleted", "name", "floor", "building", "accessibility", "checkin", "checkout", "length", "width", "height", "arrangements"],
  AddressUpdateWithoutVenueStyleInput: ["id", "createdAt", "updatedAt", "account", "type", "coords", "street", "city", "state", "country", "zipcode", "addressName", "name", "parking", "contacts", "website", "hoursOfOperation", "features", "details", "public", "primaryAccount", "deleted", "featuresOfBuisness", "phones", "rooms"],
  ContactAtAddressCreateManyEmailInput: ["accountId", "addressId", "jobTitle", "phone", "createdAt", "updatedAt", "deleted"],
  ContactAtAddressUpdateWithoutEmailInput: ["account", "address", "jobTitle", "phone", "createdAt", "updatedAt", "deleted"],
  ...
  FeatureOfRoomCreateManyFeatureInput: ["roomId", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressCreateManyFeatureInput: ["addressId", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomUpdateWithoutFeatureInput: ["room", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfAddressUpdateWithoutFeatureInput: ["address", "data", "createdAt", "updatedAt", "deleted"],
  FeatureOfRoomCreateManyRoomInput: ["featureId", "data", "createdAt", "updatedAt", "deleted"],
  ArrangementOfRoomCreateManyRoomInput: ["arrangementId", "capacity", "details", "createdAt", "updatedAt"],
  FeatureOfRoomUpdateWithoutRoomInput: ["feature", "data", "createdAt", "updatedAt", "deleted"],
  ArrangementOfRoomUpdateWithoutRoomInput: ["arrangement", "capacity", "details", "createdAt", "updatedAt"],
  AccountUpdateWithoutFilesInput: ["id", "username", "accountType", "subsciption", "employer", "employees", "accesses", "subusers", "accounts", "managers", "createdAt", "updatedAt", "lastLogin", "applied", "promoted", "retired", "title", "firstname", "midname", "lastname", "Salutation", "dob", "sex", "label", "password", "resetPasswordToken", "resetPasswordExpires", "apiToken", "deleted", "primaryAddress", "addresses", "contactOfAddress", "application", "emails", "phones", "rtw", "sia", "Status", "subscription", "transactions"],
  FilesCreateManyRtwInput: ["id", "name", "createdAt", "updatedAt", "deleted"],
  FilesUpdateWithoutRtwInput: ["id", "name", "account", "createdAt", "updatedAt", "deleted"],
  ArrangementOfRoomCreateManyArrangementInput: ["roomId", "capacity", "details", "createdAt", "updatedAt"],
  ArrangementOfRoomUpdateWithoutArrangementInput: ["room", "capacity", "details", "createdAt", "updatedAt"],
  SIACheckCreateManyBadgeInput: ["id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactionId"],
  SIACheckUpdateWithoutBadgeInput: ["id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error", "transactions"],
  StatusOnAccountCreateManyStatusInput: ["accountId", "createdAt", "updatedAt", "deleted"],
  StatusOnAccountUpdateWithoutStatusInput: ["account", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountCreateManySubscriptionInput: ["accountId", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SubscriptionOnAccountUpdateWithoutSubscriptionInput: ["account", "active", "deactivated", "activated", "startedAt", "createdAt", "updatedAt", "deleted"],
  SIACheckCreateManyTransactionsInput: ["id", "sia_id", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error"],
  SIACheckUpdateWithoutTransactionsInput: ["id", "badge", "status", "AuthUrl", "pubUrl", "createdAt", "updatedAt", "deleted", "error"]
};

	...
	[6103],
	{
		6165: function (e, t, a) {
			...
			var n = a(3366),
				...
				o = a(6742),
				s = "sidebar_2ahu",
				c = "sidebarItemTitle_2hhb",
				m = "sidebarItemList_2xAf",
				d = "sidebarItem_2UVv",
				u = "sidebarItemLink_1RT6",
			...
			function p(e) {
				...
				return 0 === t.items.length
					...
					: r.createElement(
							...
							r.createElement(
								"div",
								{ className: (0, l.Z)(c, "margin-bottom--md") },
								t.title
							),
							r.createElement(
								"ul",
		...
		3146: function (e, t, a) {
			...
			var n = a(7294),
				...
				m = a(1217),
				d = a(6146),
				u = "blogPostTitle_GeHD",
				g = "blogPostData_291c",
				v = "blogPostDetailsFull_3kfx"
			var p = function (e) {
				var t,
					a,
					p,
					E =
						((a = (0, s.c2)().selectMessage),
						function (e) {
							var t = Math.ceil(e)
							return a(
								t,
					...
					y = b.image,
					M = b.keywords,
					R = b.author_url || b.authorURL,
					A = b.author_title || b.authorTitle,
					B = b.author_image_url || b.authorImageURL
				return n.createElement(
					n.Fragment,
					null,
					n.createElement(m.Z, { keywords: M, image: y }),
					n.createElement(
						"article",
						...
						n.createElement(
							...
							n.createElement(
								p,
								{ className: u },
								Z ? P : n.createElement(o.Z, { to: I }, P)
							),
							n.createElement(
								"div",
								{ className: (0, r.Z)(g, "margin-vert--md") },
								n.createElement("time", { dateTime: k }, T),
								L && n.createElement(n.Fragment, null, " \xb7 ", E(L))
							),
							n.createElement(
								"div",
								...
								B &&
									n.createElement(
										o.Z,
										{ className: "avatar__photo-link avatar__photo", href: R },
										n.createElement("img", { src: B, alt: C })
									),
								n.createElement(
									"div",
						...
						n.createElement(
							"div",
							{ className: "markdown" },
							n.createElement(l.Zo, { components: c.Z }, h)
						),
						(w.length > 0 || _) &&
							n.createElement(
								"footer",
								...
								w.length > 0 &&
									n.createElement(
										...
										w.map(function (e) {
											...
											return n.createElement(
												o.Z,
												{ key: a, className: "margin-horiz--sm", to: a },
												t
											)
										})
									),
								...
								!Z &&
									...
									n.createElement(
										...
										n.createElement(
											o.Z,
											{ to: f.permalink, "aria-label": "Read more about " + P },
											n.createElement(
												"b",
												null,
												n.createElement(
		...
		4147: function (e, t, a) {
					...
					return n.createElement(
						...
						n.createElement(
							...
							a &&
								n.createElement(
									o.Z,
									{ className: "pagination-nav__link", to: a.permalink },
									n.createElement(
										"div",
						...
						n.createElement(
							...
							t &&
								n.createElement(
									o.Z,
									{ className: "pagination-nav__link", to: t.permalink },
									n.createElement(
										"div",
										{ className: "pagination-nav__sublabel" },
										n.createElement(
			...
			var m = function (e) {
				var t = e.content,
					...
					u = o.nextItem,
					g = o.prevItem,
					v = i.hide_table_of_contents
				return n.createElement(
					r.Z,
					{
						title: m,
						description: d,
						wrapperClassName: c.kM.wrapper.blogPages,
						pageClassName: c.kM.page.blogPostPage,
						sidebar: a,
						toc: !v && t.toc ? t.toc : void 0
					},
					n.createElement(
						l.Z,
						{ frontMatter: i, metadata: o, isBlogPostPage: !0 },
						n.createElement(t, null)
					),
					(u || g) && n.createElement(s, { nextItem: u, prevItem: g })
				)
			}
		},
		6146: function (e, t, a) {
			...
			var l = function (e, t, a) {
					...
					;(0, n.useEffect)(function () {
						function n() {
							...
							if (n)
								for (
									var r = 0, o = !1, s = document.getElementsByClassName(e);
									r < s.length && !o;

								) {
									var c = s[r],
										m = c.href,
										d = decodeURIComponent(m.substring(m.indexOf("#") + 1))
									n.id === d &&
				...
				i = "tableOfContents_35-E",
				o = "table-of-contents__link"
			function s(e) {
				var t = e.toc,
					a = e.isChild
				return t.length
					? n.createElement(
							...
							t.map(function (e) {
								return n.createElement(
									...
									n.createElement(s, { isChild: !0, toc: e.children })
								)
							})
					  )
					: null

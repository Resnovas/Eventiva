			...
			var u = r.createContext({}),
				...
				l = r.forwardRef(function (e, t) {
					var n = e.components,
						...
						l = p(n),
						m = o,
						g = l["".concat(u, ".").concat(m)] || l[m] || d[m] || s
					return n
						? r.createElement(g, i(i({ ref: t }, c), {}, { components: n }))
						: r.createElement(g, i({ ref: t }, c))
				})
			function m(e, t) {
				var n = arguments,
					o = t && t.mdxType
			...
			function l(e) {
				...
				return (0, s.kt)(
					...
					(0, s.kt)(
						...
						null,
						"For ",
						(0, s.kt)("strong", { parentName: "p" }, "Features Requests"),
						", ",
						(0, s.kt)("strong", { parentName: "p" }, "Q&A"),
						", ",
						(0, s.kt)("strong", { parentName: "p" }, "Show & Tell"),
						" and ",
						(0, s.kt)("strong", { parentName: "p" }, "Discussions"),
						" please use ",
						(0, s.kt)(
							"strong",
							{ parentName: "p" },
					...
					(0, s.kt)(
						...
						null,
						"We have a ",
						(0, s.kt)("strong", { parentName: "p" }, "FAQ"),
						" category in our ",
						(0, s.kt)(
							"strong",
							{ parentName: "p" },
					...
					(0, s.kt)(
						...
						null,
						"Our extensive ",
						(0, s.kt)("strong", { parentName: "p" }, "documentation"),
						" can be found at ",
						(0, s.kt)(
							"strong",
							{ parentName: "p" },

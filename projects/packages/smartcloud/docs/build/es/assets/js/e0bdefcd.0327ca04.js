	...
	[9269],
	{
			...
			var c = r.createContext({}),
				...
				m = r.forwardRef(function (e, t) {
					var n = e.components,
						...
						m = l(n),
						f = o,
						g = m["".concat(c, ".").concat(f)] || m[f] || p[f] || a
					return n
						? r.createElement(g, i(i({ ref: t }, s), {}, { components: n }))
		...
		3392: function (e, t, n) {
			...
			var r = n(7462),
				...
				c = void 0,
				l = {
					permalink: "/action-masterminds/es/blog/2020/04/14/blog-plugin",
					editUrl:
					...
					formattedDate: "14 de abril de 2020",
					tags: [
						{
							label: "blog",
							permalink: "/action-masterminds/es/blog/tags/blog"
						},
						{
							label: "docusaurus",
					...
					nextItem: {
						...
						permalink: "/action-masterminds/es/blog/2020/04/14/large-blog-post"
					}
				},
				s = [],
				p = { toc: s }

...
;(self.webpackChunkaction_masterminds =
	...
	[7918],
	{
		7313: function (e, t, a) {
			...
			function v(e) {
				var t = u[e.versionMetadata.banner]
			...
			function p(e) {
				var t,
					a = e.versionMetadata,
					l = (0, d.Z)().siteConfig.title,
					i = (0, r.gA)({ failfast: !0 }).pluginId,
					s = (0, m.J)(i).savePreferredVersionName,
					o = (0, r.Jo)(i),
					c = o.latestDocSuggestion,
					u = o.latestVersionSuggestion,
					p =
						null != c
							? c
							: (t = u).docs.find(function (e) {
				...
				return n.createElement(
					...
					n.createElement(
						"div",
						null,
						n.createElement(v, { siteTitle: l, versionMetadata: a })
					),
					n.createElement(
						"div",
			...
			var E = function (e) {
					...
					return "none" === t.banner
						...
						: n.createElement(p, { versionMetadata: t })
				},
				b = a(1217)
			function f(e) {
							...
							values: {
								atDate:
									t && a
										...
										: "",
								byUser: l ? n.createElement(g, { lastUpdatedBy: l }) : ""
							}
						},
			...
			var N = a(571),
				L = "tocCollapsible_1PrD",
				Z = "tocCollapsibleButton_2O1e",
				k = "tocCollapsibleContent_2Ydz",
				T = "tocCollapsibleExpanded_3GYr"
			function U(e) {
				var t,
					a = e.toc,
					r = e.className,
					i = (0, m.uR)({ initialState: !0 }),
					s = i.collapsed,
					c = i.toggleCollapsed
				return n.createElement(
					"div",
					{ className: (0, l.Z)(L, ((t = {}), (t[T] = !s), t), r) },
					n.createElement(
						"button",
						{ type: "button", className: (0, l.Z)("clean-btn", Z), onClick: c },
						n.createElement(
							o.Z,
							{
					...
					n.createElement(
						m.zF,
						{ lazy: !0, className: k, collapsed: s },
						n.createElement(N.r, { toc: a })
					)
				)
			}
			var C = a(6146),
				y = a(6159),
				w = "docItemContainer_33ec",
				A = "lastUpdated_3DPF",
				B = "docItemCol_3FnS",
				x = "tocMobile_3Hoh"
			var I = function (e) {
				var t,
					...
					u = d.keywords,
					v = d.hide_title,
					h = d.hide_table_of_contents,
					p = o.description,
					f = o.title,
					g = o.editUrl,
					L = o.lastUpdatedAt,
					Z = o.formattedLastUpdatedAt,
					k = o.lastUpdatedBy,
					T = (0, r.gA)({ failfast: !0 }).pluginId,
					I = (0, r.gB)(T).length > 1,
					M = !v && void 0 === a.contentTitle,
					D = (0, i.Z)(),
					O = !h && a.toc && a.toc.length > 0,
					S = O && ("desktop" === D || "ssr" === D)
				return n.createElement(
					n.Fragment,
					null,
					...
					n.createElement(
						...
						n.createElement(
							"div",
							{ className: (0, l.Z)("col", ((t = {}), (t[B] = !h), t)) },
							n.createElement(E, { versionMetadata: s }),
							n.createElement(
								"div",
								{ className: w },
								n.createElement(
									...
									O && n.createElement(U, { toc: a.toc, className: x }),
									n.createElement(
										"div",
										{ className: "markdown" },
										M && n.createElement(y.N, null, f),
									...
									(g || L || k) &&
										n.createElement(
											...
											n.createElement(
												"div",
												{ className: "col" },
												g && n.createElement(C.Z, { editUrl: g })
											),
											n.createElement(
												"div",
												{ className: (0, l.Z)("col", A) },
												(L || k) &&
													n.createElement(_, {
														lastUpdatedAt: L,
														formattedLastUpdatedAt: Z,
														lastUpdatedBy: k
													})
											)
										)
								),
								n.createElement(c, { metadata: o })
							)
						),
						S &&
							n.createElement(
			...
			var r = function (e, t, a) {
					...
					;(0, n.useEffect)(function () {
						function n() {
							...
							if (n)
								for (
									var l = 0, s = !1, o = document.getElementsByClassName(e);
									l < o.length && !s;

								) {
									var c = o[l],
										d = c.href,
										m = decodeURIComponent(d.substring(d.indexOf("#") + 1))
									n.id === m &&
					...
					? n.createElement(
							...
							t.map(function (e) {
								return n.createElement(
									...
									n.createElement(o, { isChild: !0, toc: e.children })
								)
							})
					  )
					: null

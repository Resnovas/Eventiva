...
export class SubuserOnAccountUpdateManyWithoutSubuserInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [SubuserOnAccountUpsertWithWhereUniqueWithoutSubuserInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [SubuserOnAccountUpdateWithWhereUniqueWithoutSubuserInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [SubuserOnAccountUpdateManyWithWhereWithoutSubuserInput],
    {
      nullable: true,
    }
  )

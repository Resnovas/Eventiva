...
export class AddressUpdateManyWithoutAccountInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [AddressUpsertWithWhereUniqueWithoutAccountInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [AddressUpdateWithWhereUniqueWithoutAccountInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [AddressUpdateManyWithWhereWithoutAccountInput],
    {
      nullable: true,
    }
  )

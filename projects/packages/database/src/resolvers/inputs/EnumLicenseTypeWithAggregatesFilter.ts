...
import { NestedEnumLicenseTypeWithAggregatesFilter } from '../inputs/NestedEnumLicenseTypeWithAggregatesFilter';
import { NestedIntFilter } from '../inputs/NestedIntFilter';
import { LicenseType } from '../../enums/LicenseType';

@TypeGraphQL.InputType('EnumLicenseTypeWithAggregatesFilter', {
  isAbstract: true,
})
export class EnumLicenseTypeWithAggregatesFilter {

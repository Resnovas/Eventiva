...
export class SubscriptionOnAccountUpdateManyWithoutAccountInput {
  ...
  @TypeGraphQL.Field(
    (_type) => [SubscriptionOnAccountCreateOrConnectWithoutAccountInput],
    {
      nullable: true,
    }
  )
  connectOrCreate?:
    | SubscriptionOnAccountCreateOrConnectWithoutAccountInput[]
    | undefined;

  @TypeGraphQL.Field(
    (_type) => [SubscriptionOnAccountUpsertWithWhereUniqueWithoutAccountInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => SubscriptionOnAccountCreateManyAccountInputEnvelope,
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [SubscriptionOnAccountUpdateWithWhereUniqueWithoutAccountInput],
    {
      nullable: true,
    }
  )
  ...
  @TypeGraphQL.Field(
    (_type) => [SubscriptionOnAccountUpdateManyWithWhereWithoutAccountInput],
    {
      nullable: true,
    }
  )

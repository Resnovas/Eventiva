...
export class ApplicationCrudResolver {
  ...
  async application(
    ...
    @TypeGraphQL.Args() args: FindUniqueApplicationArgs
  ...
  async findFirstApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstApplicationArgs
  ): Promise<Application | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async applications(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyApplicationArgs
  ): Promise<Application[]> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateApplicationArgs
  ): Promise<Application> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyApplicationArgs
  ...
  async deleteApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteApplicationArgs
  ): Promise<Application | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateApplicationArgs
  ): Promise<Application | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async deleteManyApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyApplicationArgs
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateManyApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyApplicationArgs
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async upsertApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertApplicationArgs
  ): Promise<Application> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregateApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateApplicationArgs
  ...
  async groupByApplication(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByApplicationArgs
  ): Promise<ApplicationGroupBy[]> {

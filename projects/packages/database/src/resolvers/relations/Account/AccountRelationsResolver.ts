...
export class AccountRelationsResolver {
  ...
  async employer(
    ...
    @TypeGraphQL.Args() args: AccountEmployerArgs
  ...
  async employees(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountEmployeesArgs
  ): Promise<EmployersOnAccount[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async accesses(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountAccessesArgs
  ...
  async subusers(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountSubusersArgs
  ): Promise<SubuserOnAccount[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async accounts(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountAccountsArgs
  ...
  async managers(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountManagersArgs
  ): Promise<ManagersOnAccount[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async apiToken(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountApiTokenArgs
  ): Promise<Token[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async addresses(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountAddressesArgs
  ): Promise<Address[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async contactOfAddress(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountContactOfAddressArgs
  ...
  async application(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountApplicationArgs
  ): Promise<Application[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async emails(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountEmailsArgs
  ): Promise<Email[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async files(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountFilesArgs
  ): Promise<Files[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async phones(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountPhonesArgs
  ): Promise<Phone[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async rtw(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountRtwArgs
  ): Promise<RTW[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async sia(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountSiaArgs
  ): Promise<SIABadge[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {
  ...
  async Status(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountStatusArgs
  ...
  async subscription(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountSubscriptionArgs
  ...
  async transactions(
    @TypeGraphQL.Root() account: Account,
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Args() args: AccountTransactionsArgs
  ): Promise<Transaction[]> {
    return getPrismaFromContext(ctx)
      .account.findUnique({
        where: {

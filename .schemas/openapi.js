...
fs.writeFileSync('./.schemas/openapi.json', JSON.stringify(openapiSpecification, null, 2), { encoding: 'utf8' });
fs.writeFileSync('./.schemas/openapi.yaml', YAML.stringify(openapiSpecification, null, 2), { encoding: 'utf8' });